...
|---|---|---|---|---|
| [Cat Facts](https://alexwohlbruck.github.io/cat-facts/) | 고양이에 대한 사실 | 아니요 | 예 | 아니요 |
| [Cats](https://docs.thecatapi.com/) | 텀블러에서 가져온 고양이 사진 | `apiKey` | 예 | 알 수 없음 |
| [Dogs](https://dog.ceo/dog-api/) | 스탠포드의 개 데이터셋에 기반함 | 아니요 | 예 | 예 |
| [HTTPCat](https://http.cat/) | 모든 HTTP 상태를 위한 고양이 | 아니요 | 예 | 알 수 없음 |
| [IUCN](http://apiv3.iucnredlist.org/api/v3/docs) | IUCN 적색목록의 위협종 | `apiKey` | 아니요 | 알 수 없음 |
| [Movebank](https://github.com/movebank/movebank-api-doc) | 동물의 움직임과 이주 데이터 | 아니요 | 예 | 알 수 없음 |
| [Petfinder](https://www.petfinder.com/developers/v2/docs/) | 입양 | `OAuth` | 예 | 예 |
| [PlaceGOAT](https://placegoat.com/) | 플레이스 홀더 염소 이미지 | 아니요 | 예 | 알 수 없음 |
| [RandomCat](https://aws.random.cat/meow) | 무작위 고양이 사진 | 아니요 | 예 | 예 |
| [RandomDog](https://random.dog/woof.json) | 무작위 개 사진 | 아니요 | 예 | 예 |
| [RandomFox](https://randomfox.ca/floof/) | 무작위 여우 사진 | 아니요 | 예 | 아니요 |
| [RescueGroups](https://userguide.rescuegroups.org/display/APIDG/API+Developers+Guide+Home) | 입양 | 아니요 | 예 | 알 수 없음 |
| [Shibe.Online](http://shibe.online/) | 무작위 시바견, 고양이 또는 새 사진 | 아니요 | 아니요 | 아니요 |

**[⬆ 목차로 돌아가기](#목차)**
### 애니메이션
API | 설명 | 인증 | HTTPS | CORS |
|---|---|---|---|---|
| [AniList](https://github.com/AniList/ApiV2-GraphQL-Docs) | Anime discovery & tracking | `OAuth` | 예 | 알 수 없음 |
| [AnimeNewsNetwork](https://www.animenewsnetwork.com/encyclopedia/api.php) | Anime industry news | 아니요 | 예 | 예 |
| [Jikan](https://jikan.moe) | Unofficial MyAnimeList API | 아니요 | 예 | 예 |
| [Kitsu](http://docs.kitsu.apiary.io/) | Anime discovery platform | `OAuth` | 예 | 알 수 없음 |
| [Studio Ghibli](https://ghibliapi.herokuapp.com) | Resources from Studio Ghibli films | 아니요 | 예 | 알 수 없음 |

**[⬆ 목차로 돌아가기](#목차)**
### 안티멀웨어
API | 설명 | 인증 | HTTPS | CORS |
|---|---|---|---|---|
| [AbuseIPDB](https://docs.abuseipdb.com/) | IP/domain/URL reputation | `apiKey` | 예 | 알 수 없음 |
| [AlienVault Open Threat Exchange (OTX)](https://otx.alienvault.com/api/) | IP/domain/URL reputation | `apiKey` | 예 | 알 수 없음 |
| [Google Safe Browsing](https://developers.google.com/safe-browsing/) | Google Link/Domain Flagging | `apiKey` | 예 | 알 수 없음 |
| [Metacert](https://metacert.com/) | Metacert Link Flagging | `apiKey` | 예 | 알 수 없음 |
| [VirusTotal](https://www.virustotal.com/en/documentation/public-api/) | VirusTotal File/URL Analysis | `apiKey` | 예 | 알 수 없음 |
| [Web Of Trust (WOT)](https://www.mywot.com/en/API) | Website reputation | `apiKey` | 예 | 알 수 없음 |

**[⬆ 목차로 돌아가기](#목차)**
### 예술 & 디자인
API | 설명 | 인증 | HTTPS | CORS |
|---|---|---|---|---|
| [Behance](https://www.behance.net/dev) | Design | `apiKey` | 예 | 알 수 없음 |
| [Cooper Hewitt](https://collection.cooperhewitt.org/api) | Smithsonian Design Museum | `apiKey` | 예 | 알 수 없음 |
| [Dribbble](http://developer.dribbble.com/v1/) | Design | `OAuth` | 아니요 | 알 수 없음 |
| [Harvard Art Museums](https://github.com/harvardartmuseums/api-docs) | Art | `apiKey` | 아니요 | 알 수 없음 |
| [Iconfinder](https://developer.iconfinder.com) | Icons | `apiKey` | 예 | 알 수 없음 |
| [Icons8](http://docs.icons8.apiary.io/#reference/0/meta) | Icons | `OAuth` | 예 | 알 수 없음 |
| [Noun Project](http://api.thenounproject.com/목차.html) | Icons | `OAuth` | 아니요 | 알 수 없음 |
| [Rijksmuseum](https://www.rijksmuseum.nl/en/api) | Art | `apiKey` | 예 | 알 수 없음 |

**[⬆ 목차로 돌아가기](#목차)**
### 책
API | 설명 | 인증 | HTTPS | CORS |
|---|---|---|---|---|
| [Bhagavad Gita](https://bhagavadgita.io/api) | Bhagavad Gita text | `OAuth` | 예 | 예 |
| [BookNomads](https://www.booknomads.com/dev) | Books published in the Netherlands and Flanders (about 2.5 million), book covers and related data | 아니요 | 예 | 알 수 없음 |
| [British National Bibliography](http://bnb.data.bl.uk/) | Books | 아니요 | 아니요 | 알 수 없음 |
| [Goodreads](https://www.goodreads.com/api) | Books | `apiKey` | 예 | 알 수 없음 |
| [Google Books](https://developers.google.com/books/) | Books | `OAuth` | 예 | 알 수 없음 |
| [LibGen](http://garbage.world/posts/libgen/) | Library Genesis search engine | 아니요 | 아니요 | 알 수 없음 |
| [Open Library](https://openlibrary.org/developers/api) | Books, book covers and related data | 아니요 | 예 | 알 수 없음 |
| [Penguin Publishing](http://www.penguinrandomhouse.biz/webservices/rest/) | Books, book covers and related data | 아니요 | 예 | 알 수 없음 |
...
API | 설명 | 인증 | HTTPS | CORS |
|---|---|---|---|---|
| [Binance](https://github.com/binance-exchange/binance-official-api-docs) | Exchange for Trading Cryptocurrencies based in China | `apiKey` | 예 | 알 수 없음 |
| [BitcoinAverage](https://apiv2.bitcoinaverage.com/) | Digital Asset Price Data for the blockchain industry | `apiKey` | 예 | 알 수 없음 |
| [BitcoinCharts](https://bitcoincharts.com/about/exchanges/) | Financial and Technical Data related to the Bitcoin Network | 아니요 | 예 | 알 수 없음 |
| [Bitfinex](https://docs.bitfinex.com/docs/getting-started) | Cryptocurrency Trading Platform | `apiKey` | 예 | 알 수 없음 |
| [Bitmex](https://www.bitmex.com/app/apiOverview) | Real-Time Cryptocurrency derivatives trading platform based in Hong Kong | `apiKey` | 예 | 알 수 없음 |
| [Bittrex](https://bittrex.com/Home/Api) | Next Generation Crypto Trading Platform | `apiKey` | 예 | 알 수 없음 |
| [Block](https://www.block.io/docs/basic) | Bitcoin Payment, Wallet & Transaction Data | `apiKey` | 예 | 알 수 없음 |
| [Blockchain](https://www.blockchain.info/api) | Bitcoin Payment, Wallet & Transaction Data | 아니요 | 예 | 알 수 없음 |
| [CoinAPI](https://docs.coinapi.io/) | All Currency Exchanges integrate under a single api | `apiKey` | 예 | 아니요 |
| [Coinbase](https://developers.coinbase.com) | Bitcoin, Bitcoin Cash, Litecoin and Ethereum Prices | `apiKey` | 예 | 알 수 없음 |
| [Coinbase Pro](https://docs.pro.coinbase.com/#api) | Cryptocurrency Trading Platform | `apiKey` | 예 | 알 수 없음 |
| [CoinDesk](http://www.coindesk.com/api/) | Bitcoin Price Index | 아니요 | 아니요 | 알 수 없음 |
| [CoinGecko](http://www.coingecko.com/api) | Cryptocurrency Price, Market, and Developer/Social Data | 아니요 | 예 | 예 |
| [Coinigy](https://coinigy.docs.apiary.io) | Interacting with Coinigy Accounts and Exchange Directly | `apiKey` | 예 | 알 수 없음 |
| [CoinLayer](https://coinlayer.com) | Real-time Crypto Currency Exchange Rates | `apiKey` | 예 | 알 수 없음 |
| [Coinlib](https://coinlib.io/apidocs) | Crypto Currency Prices | `apiKey` | 예 | 알 수 없음 |
| [Coinlore](https://www.coinlore.com/cryptocurrency-data-api) | Cryptocurrencies prices, volume and more | 아니요 | 예 | 알 수 없음 |
| [CoinMarketCap](https://coinmarketcap.com/api/) | Cryptocurrencies Prices | `apiKey` | 예 | 알 수 없음 |
| [Coinpaprika](https://api.coinpaprika.com) | Cryptocurrencies prices, volume and more | 아니요 | 예 | 예 |
| [CoinRanking](https://docs.coinranking.com/) | Live Cryptocurrency data | 아니요 | 예 | 알 수 없음 |
| [CryptoCompare](https://www.cryptocompare.com/api#) | Cryptocurrencies Comparison | 아니요 | 예 | 알 수 없음 |
| [Cryptonator](https://www.cryptonator.com/api/) | Cryptocurrencies Exchange Rates | 아니요 | 예 | 알 수 없음 |
| [Gemini](https://docs.gemini.com/rest-api/) | Cryptocurrencies Exchange | 아니요 | 예 | 알 수 없음 |
| [ICObench](https://icobench.com/developers) | Various information on listing, ratings, stats, and more | `apiKey` | 예 | 알 수 없음 |
| [Livecoin](https://www.livecoin.net/api) | Cryptocurrency Exchange | 아니요 | 예 | 알 수 없음 |
| [MercadoBitcoin](https://www.mercadobitcoin.net/api-doc/) | Brazilian Cryptocurrency Information | 아니요 | 예 | 알 수 없음 |
| [Nexchange](https://nexchange2.docs.apiary.io/) | Automated cryptocurrency exchange service | 아니요 | 아니요 | 예 |
| [NiceHash](https://docs.nicehash.com/) | Largest Crypto Mining Marketplace | `apiKey` | 예 | 알 수 없음 |
| [Poloniex](https://poloniex.com/support/api/) | US based digital asset exchange | `apiKey` | 예 | 알 수 없음 |
| [WorldCoinIndex](https://www.worldcoinindex.com/apiservice) | Cryptocurrencies Prices | `apiKey` | 예 | 알 수 없음 |
...
API | 설명 | 인증 | HTTPS | CORS |
|---|---|---|---|---|
| [Cloudmersive Document and Data Conversion](https://cloudmersive.com/convert-api) | HTML/URL to PDF/PNG, Office documents to PDF, image conversion | `apiKey` | 예 | 예 |
| [File.io](https://www.file.io) | File Sharing | 아니요 | 예 | 알 수 없음 |
| [Mercury](https://mercury.postlight.com/web-parser/) | Web parser | `apiKey` | 예 | 알 수 없음 |
| [pdflayer](https://pdflayer.com) | HTML/URL to PDF | `apiKey` | 예 | 알 수 없음 |
| [Pocket](https://getpocket.com/developer/) | Bookmarking service | `OAuth` | 예 | 알 수 없음 |
| [PrexView](https://prexview.com) | Data from XML or JSON to PDF, HTML or Image | `apiKey` | 예 | 알 수 없음 |
| [Restpack](https://restpack.io/) | Provides screenshot, HTML to PDF and content extraction APIs | `apiKey` | 예 | 알 수 없음 |
| [Todoist](https://developer.todoist.com) | Todo Lists | `OAuth` | 예 | 알 수 없음 |
| [Vector Express](http://vector.express) | Free vector file converting API | 아니요 | 아니요 | 예 |
| [WakaTime](https://wakatime.com/developers) | Automated time tracking leaderboards for programmers | 아니요 | 예 | 알 수 없음 |
| [Wunderlist](https://developer.wunderlist.com/documentation) | Todo Lists | `OAuth` | 예 | 알 수 없음 |
...
API | 설명 | 인증 | HTTPS | CORS |
|---|---|---|---|---|
| [Alpha Vantage](https://www.alphavantage.co/) | Realtime and historical stock data | `apiKey` | 예 | 알 수 없음 |
| [Barchart OnDemand](https://www.barchartondemand.com/free) | Stock, Futures and Forex Market Data | `apiKey` | 예 | 알 수 없음 |
| [Consumer Financial Protection Bureau](https://data.consumerfinance.gov/resource/jhzv-w97w.json) | Financial services consumer complaint data | `apiKey` | 예 | 알 수 없음 |
| [Financial Modeling Prep](https://financialmodelingprep.com/) | Stock information and data | 아니요 | 예 | 알 수 없음 |
| [IEX](https://iextrading.com/developer/) | Realtime stock data | 아니요 | 예 | 예 |
| [IEX Cloud](https://iexcloud.io/) | Realtime & Historical Stock and Market Data | `apiKey` | 예 | 예 |
| [IG](https://labs.ig.com/gettingstarted) | Spreadbetting and CFD Market Data | `apiKey` | 예 | 알 수 없음 |
| [Plaid](https://plaid.com/) | Connect with users’ bank accounts and access transaction data | `apiKey` | 예 | 알 수 없음 |
| [Razorpay IFSC](https://ifsc.razorpay.com/) | Indian Financial Systems Code (Bank Branch Codes) | 아니요 | 예 | 알 수 없음 |
| [RoutingNumbers.info](https://www.routingnumbers.info/api/index.html) | ACH/NACHA Bank Routing Numbers | 아니요 | 예 | 알 수 없음 |
| [Tradier](https://developer.tradier.com) | US equity/option market data (delayed, intraday, historical) | `OAuth` | 예 | 예 |
| [VAT Rates](https://jsonvat.com/) | A collection of all VAT rates for EU countries | 아니요 | 예 | 알 수 없음 |
| [YNAB](https://api.youneedabudget.com/) | Budgeting & Planning | `OAuth` | 예 | 예 |
...
API | 설명 | 인증 | HTTPS | CORS |
|---|---|---|---|---|
| [adresse.data.gouv.fr](https://adresse.data.gouv.fr) | Address database of France, geocoding and reverse | 아니요 | 예 | 알 수 없음 |
| [Battuta](http://battuta.medunes.net) | A (country/region/city) in-cascade location API | `apiKey` | 아니요 | 알 수 없음 |
| [Bing Maps](https://www.microsoft.com/maps/) | Create/customize digital maps based on Bing Maps data | `apiKey` | 예 | 알 수 없음 |
| [bng2latlong](https://www.getthedata.com/bng2latlong) | Convert British OSGB36 easting and northing (British National Grid) to WGS84 latitude and longitude | 아니요 | 예 | 예 |
| [CitySDK](http://www.citysdk.eu/citysdk-toolkit/) | Open APIs for select European cities | 아니요 | 예 | 알 수 없음 |
| [Daum Maps](http://apis.map.daum.net/) | Daum Maps provide multiple APIs for Korean maps | `apiKey` | 아니요 | 알 수 없음 |
| [FreeGeoIP](https://freegeoip.app/) | Free geo ip information, no registration required. 15k/hour rate limit | 아니요 | 예 | 예 |
| [GeoApi](https://api.gouv.fr/api/geoapi.html) | French geographical data | 아니요 | 예 | 알 수 없음 |
| [Geocod.io](https://www.geocod.io/) | Address geocoding / reverse geocoding in bulk | `apiKey` | 예 | 알 수 없음 |
| [Geocode.xyz](https://geocode.xyz/) | Provides worldwide forward/reverse geocoding, batch geocoding and geoparsing | 아니요 | 예 | 알 수 없음 |
| [GeoDataSource](https://www.geodatasource.com/web-service) | Geocoding of city name by using latitude and longitude coordinates | `apiKey` | 예 | 알 수 없음 |
| [GeoJS](https://geojs.io/) | IP geolocation with ChatOps integration | 아니요 | 예 | 예 |
| [GeoNames](http://www.geonames.org/export/web-services.html) | Place names and other geographical data | 아니요 | 아니요 | 알 수 없음 |
| [geoPlugin](https://www.geoplugin.com) | IP geolocation and currency conversion | 아니요 | 예 | 예 |
| [Google Earth Engine](https://developers.google.com/earth-engine/) | A cloud-based platform for planetary-scale environmental data analysis | `apiKey` | 예 | 알 수 없음 |
| [Google Maps](https://developers.google.com/maps/) | Create/customize digital maps based on Google Maps data | `apiKey` | 예 | 알 수 없음 |
| [HelloSalut](https://www.fourtonfish.com/hellosalut/hello/) | Get hello translation following user language | 아니요 | 예 | 알 수 없음 |
| [HERE Maps](https://developer.here.com) | Create/customize digital maps based on HERE Maps data | `apiKey` | 예 | 알 수 없음 |
| [Indian Cities](https://indian-cities-api-nocbegfhqg.now.sh/) | Get all Indian cities in a clean JSON Format | 아니요 | 예 | 예 |
| [IP 2 Country](https://ip2country.info) | Map an IP to a country | 아니요 | 예 | 알 수 없음 |
| [IP Address Details](https://ipinfo.io/) | Find geolocation with ip address | 아니요 | 예 | 알 수 없음 |
| [IP Location](http://ip-api.com/) | Find location with ip address | 아니요 | 아니요 | 알 수 없음 |
| [IP Location](https://ipapi.co/) | Find IP address location information | 아니요 | 예 | 알 수 없음 |
| [IP Sidekick](https://ipsidekick.com) | Geolocation API that returns extra information about an IP address | `apiKey` | 예 | 알 수 없음 |
| [IP Vigilante](https://www.ipvigilante.com/) | Free IP Geolocation API | 아니요 | 예 | 알 수 없음 |
| [IP2Location](https://www.ip2location.com/web-service/ip2location) | IP geolocation web service to get more than 55 parameters | `apiKey` | 예 | 알 수 없음 |
| [IP2Proxy](https://www.ip2location.com/web-service/ip2proxy) | Detect proxy and VPN using IP address | `apiKey` | 예 | 알 수 없음 |
| [IPGeolocationAPI.com](https://ipgeolocationapi.com/) | Locate your visitors by IP with country details | 아니요 | 예 | 예 |
| [IPInfoDB](https://ipinfodb.com/api) | Free Geolocation tools and APIs for country, region, city and time zone lookup by IP address | `apiKey` | 예 | 알 수 없음 |
| [ipstack](https://ipstack.com/) | Locate and identify website visitors by IP address | `apiKey` | 예 | 알 수 없음 |
| [Kwelo Network](https://www.kwelo.com/network/ip-address) | Locate and get detailed information on IP address | 아니요 | 예 | 예 |
| [LocationIQ](https://locationiq.org/docs/) | Provides forward/reverse geocoding and batch geocoding | `apiKey` | 예 | 예 |
| [Mapbox](https://www.mapbox.com/developers/) | Create/customize beautiful digital maps | `apiKey` | 예 | 알 수 없음 |
| [Mexico](https://github.com/IcaliaLabs/sepomex) | Mexico RESTful zip codes API | 아니요 | 예 | 알 수 없음 |
| [One Map, Singapore](https://docs.onemap.sg/) | Singapore Land Authority REST API services for Singapore addresses | `apiKey` | 예 | 알 수 없음 |
| [OnWater](https://onwater.io/) | Determine if a lat/lon is on water or land | 아니요 | 예 | 알 수 없음 |
| [OpenCage](https://opencagedata.com) | Forward and reverse geocoding using open data | `apiKey` | 예 | 예 |
| [OpenStreetMap](http://wiki.openstreetmap.org/wiki/API) | Navigation, geolocation and geographical data | `OAuth` | 아니요 | 알 수 없음 |
| [PostcodeData.nl](http://api.postcodedata.nl/v1/postcode/?postcode=1211EP&streetnumber=60&ref=domeinnaam.nl&type=json) | Provide geolocation data based on postcode for Dutch addresses | 아니요 | 아니요 | 알 수 없음 |
| [Postcodes.io](https://postcodes.io) | Postcode lookup & Geolocation for the UK | 아니요 | 예 | 예 |
| [REST Countries](https://restcountries.eu) | Get information about countries via a RESTful API | 아니요 | 예 | 알 수 없음 |
| [SmartIP.io](https://smartip.io) | IP Geolocation and Threat Intelligence API | `apiKey` | 예 | 예 |
| [Uebermaps](https://uebermaps.com/api/v2) | Discover and share maps with friends | `apiKey` | 예 | 알 수 없음 |
| [US ZipCode](https://smartystreets.com/docs/cloud/us-zipcode-api) | Validate and append data for any US ZipCode | `apiKey` | 예 | 예 |
| [Utah AGRC](https://api.mapserv.utah.gov) | Utah Web API for geocoding Utah addresses | `apiKey` | 예 | 알 수 없음 |
| [ViaCep](https://viacep.com.br) | Brazil RESTful zip codes API | 아니요 | 예 | 알 수 없음 |
| [ZipCodeAPI](https://www.zipcodeapi.com) | US zip code distance, radius and location API | `apiKey` | 예 | 알 수 없음 |
| [Zippopotam](http://www.zippopotam.us) | Get information about place such as country, city, state, etc | 아니요 | 아니요 | 알 수 없음 |
...
API | 설명 | 인증 | HTTPS | CORS |
|---|---|---|---|---|
| [AI Mastering](https://aimastering.com/api_docs/) | Automated Music Mastering | `apiKey` | 예 | 예 |
| [Bandsintown](https://app.swaggerhub.com/apis/Bandsintown/PublicAPI/3.0.0) | Music Events | 아니요 | 예 | 알 수 없음 |
| [Deezer](https://developers.deezer.com/api) | Music | `OAuth` | 예 | 알 수 없음 |
| [Discogs](https://www.discogs.com/developers/) | Music | `OAuth` | 예 | 알 수 없음 |
| [Genius](https://docs.genius.com/) | Crowdsourced lyrics and music knowledge | `OAuth` | 예 | 알 수 없음 |
| [Genrenator](https://binaryjazz.us/genrenator-api/) | Music genre generator | 아니요 | 예 | 알 수 없음 |
| [iTunes Search](https://affiliate.itunes.apple.com/resources/documentation/itunes-store-web-service-search-api/) | Software products | 아니요 | 예 | 알 수 없음 |
| [Jamendo](https://developer.jamendo.com/v3.0/docs) | Music | `OAuth` | 예 | 알 수 없음 |
| [KKBOX](https://developer.kkbox.com) | Get music libraries, playlists, charts, and perform out of KKBOX's platform | `OAuth` | 예 | 알 수 없음 |
| [LastFm](https://www.last.fm/api) | Music | `apiKey` | 예 | 알 수 없음 |
| [Lyrics.ovh](http://docs.lyricsovh.apiary.io/) | Simple API to retrieve the lyrics of a song | 아니요 | 예 | 알 수 없음 |
| [Mixcloud](https://www.mixcloud.com/developers/) | Music | `OAuth` | 예 | 예 |
| [MusicBrainz](https://musicbrainz.org/doc/Development/XML_Web_Service/Version_2) | Music | 아니요 | 예 | 알 수 없음 |
| [Musikki](https://music-api.musikki.com/reference) | Music | `apiKey` | 예 | 알 수 없음 |
| [Musixmatch](https://developer.musixmatch.com/) | Music | `apiKey` | 예 | 알 수 없음 |
| [Openwhyd](https://openwhyd.github.io/openwhyd/API) | Download curated playlists of streaming tracks (YouTube, SoundCloud, etc...) | `아니요` | 예 | 아니요 |
| [Songkick](https://www.songkick.com/developer/) | Music Events | `OAuth` | 예 | 알 수 없음 |
| [Songsterr](https://www.songsterr.com/a/wa/api/) | Provides guitar, bass and drums tabs and chords | 아니요 | 예 | 알 수 없음 |
| [SoundCloud](https://developers.soundcloud.com/) | Allow users to upload and share sounds | `OAuth` | 예 | 알 수 없음 |
| [Spotify](https://beta.developer.spotify.com/documentation/web-api/) | View Spotify music catalog, manage users' libraries, get recommendations and more | `OAuth` | 예 | 알 수 없음 |
| [TasteDive](https://tastedive.com/read/api) | Similar artist API (also works for movies and TV shows) | `apiKey` | 예 | 알 수 없음 |
| [TheAudioDB](https://www.theaudiodb.com/api_guide.php) | Music | `apiKey` | 예 | 알 수 없음 |
| [Vagalume](https://api.vagalume.com.br/docs/) | Crowdsourced lyrics and music knowledge | `apiKey` | 예 | 알 수 없음 |
...
API | 설명 | 인증 | HTTPS | CORS |
|---|---|---|---|---|
| [Best Buy](https://bestbuyapis.github.io/api-documentation/#overview) | Products, Buying Options, Categories, Recommendations, Stores and Commerce | `apiKey` | 예 | 알 수 없음 |
| [Bratabase](https://developers.bratabase.com/) | Database of different types of Bra Sizes | `OAuth` | 예 | 알 수 없음 |
| [eBay](https://go.developer.ebay.com/) | Sell and Buy on eBay | `OAuth` | 예 | 알 수 없음 |
| [Wal-Mart](https://developer.walmartlabs.com/docs) | Item price and availability | `apiKey` | 예 | 알 수 없음 |
| [Wegmans](https://dev.wegmans.io) | Wegmans Food Markets | `apiKey` | 예 | 알 수 없음 |

**[⬆ 목차로 돌아가기](#목차)**
### 소셜
API | 설명 | 인증 | HTTPS | CORS |
|---|---|---|---|---|
| [Buffer](https://buffer.com/developers/api) | Access to pending and sent updates in Buffer | `OAuth` | 예 | 알 수 없음 |
| [Cisco Spark](https://developer.ciscospark.com) | Team Collaboration Software | `OAuth` | 예 | 알 수 없음 |
| [Discord](https://discordapp.com/developers/docs/intro) | Make bots for Discord, integrate Discord onto an external platform | `OAuth` | 예 | 알 수 없음 |
| [Disqus](https://disqus.com/api/docs/auth/) | Communicate with Disqus data | `OAuth` | 예 | 알 수 없음 |
| [Facebook](https://developers.facebook.com/) | Facebook Login, Share on FB, Social Plugins, Analytics and more | `OAuth` | 예 | 알 수 없음 |
| [Foursquare](https://developer.foursquare.com/) | Interact with Foursquare users and places (geolocation-based checkins, photos, tips, events, etc) | `OAuth` | 예 | 알 수 없음 |
| [Fuck Off as a Service](https://www.foaas.com) | Asks someone to fuck off | 아니요 | 예 | 알 수 없음 |
| [Full Contact](https://www.fullcontact.com/developer/docs/) | Get Social Media profiles and contact Information | `OAuth` | 예 | 알 수 없음 |
| [HackerNews](https://github.com/HackerNews/API) | Social news for CS and entrepreneurship | 아니요 | 예 | 알 수 없음 |
| [Instagram](https://www.instagram.com/developer/) | Instagram Login, Share on Instagram, Social Plugins and more | `OAuth` | 예 | 알 수 없음 |
| [LinkedIn](https://developer.linkedin.com/docs/rest-api) | The foundation of all digital integrations with LinkedIn | `OAuth` | 예 | 알 수 없음 |
| [Meetup.com](https://www.meetup.com/meetup_api/) | Data about Meetups from Meetup.com | `apiKey` | 예 | 알 수 없음 |
| [Mixer](https://dev.mixer.com/) | Game Streaming API | `OAuth` | 예 | 알 수 없음 |
| [MySocialApp](https://mysocialapp.io) | Seamless Social Networking features, API, SDK to any app | `apiKey` | 예 | 알 수 없음 |
| [Open Collective](https://docs.opencollective.com/help/developers/api) | Get Open Collective data | 아니요 | 예 | 알 수 없음 |
| [Pinterest](https://developers.pinterest.com/) | The world's catalog of ideas | `OAuth` | 예 | 알 수 없음 |
| [PWRTelegram bot](https://pwrtelegram.xyz) | Boosted version of the Telegram bot API | `OAuth` | 예 | 알 수 없음 |
| [Reddit](https://www.reddit.com/dev/api) | Homepage of the internet | `OAuth` | 예 | 알 수 없음 |
| [SharedCount](http://docs.sharedcount.com/) | Social media like and share data for any URL | `apiKey` | 예 | 알 수 없음 |
| [Slack](https://api.slack.com/) | Team Instant Messaging | `OAuth` | 예 | 알 수 없음 |
...
API | 설명 | 인증 | HTTPS | CORS |
|---|---|---|---|---|
| [ADS-B Exchange](https://www.adsbexchange.com/data/) | Access real-time and historical data of any and all airborne aircraft | 아니요 | 예 | 알 수 없음 |
| [AIS Hub](http://www.aishub.net/api) | Real-time data of any marine and inland vessel equipped with AIS tracking system | `apiKey` | 아니요 | 알 수 없음 |
| [AIS Web](http://www.aisweb.aer.mil.br/api/doc/index.cfm) | Aeronautical information in digital media produced by the Department of Airspace Control (DECEA) | `apiKey` | 아니요 | 알 수 없음 |
| [Amadeus Travel Innovation Sandbox](https://sandbox.amadeus.com/) | Travel Search - Limited usage | `apiKey` | 예 | 알 수 없음 |
| [Bay Area Rapid Transit](http://api.bart.gov) | Stations and predicted arrivals for BART | `apiKey` | 아니요 | 알 수 없음 |
| [BlaBlaCar](https://dev.blablacar.com) | Search car sharing trips | `apiKey` | 예 | 알 수 없음 |
| [Community Transit](https://github.com/transitland/transitland-datastore/blob/master/README.md#api-endpoints) | Transitland API | 아니요 | 예 | 알 수 없음 |
| [Goibibo](https://developer.goibibo.com/docs) | API for travel search | `apiKey` | 예 | 알 수 없음 |
| [GraphHopper](https://graphhopper.com/api/1/docs/) | A-to-B routing with turn-by-turn instructions | `apiKey` | 예 | 알 수 없음 |
| [Icelandic APIs](http://docs.apis.is/) | Open APIs that deliver services in or regarding Iceland | 아니요 | 예 | 알 수 없음 |
| [Indian Railways](http://api.erail.in/) | Indian Railways Information | `apiKey` | 아니요 | 알 수 없음 |
| [Izi](http://api-docs.izi.travel/) | Audio guide for travellers | `apiKey` | 예 | 알 수 없음 |
| [Metro Lisboa](http://app.metrolisboa.pt/status/getLinhas.php) | Delays in subway lines | 아니요 | 아니요 | 아니요 |
| [Navitia](https://api.navitia.io/) | The open API for building cool stuff with transport data | `apiKey` | 예 | 알 수 없음 |
| [REFUGE Restrooms](https://www.refugerestrooms.org/api/docs/#!/restrooms) | Provides safe restroom access for transgender, intersex and gender nonconforming individuals | 아니요 | 예 | 알 수 없음 |
| [Schiphol Airport](https://developer.schiphol.nl/) | Schiphol | `apiKey` | 예 | 알 수 없음 |
| [TransitLand](https://transit.land/documentation/datastore/api-endpoints.html) | Transit Aggregation | 아니요 | 예 | 알 수 없음 |
| [Transport for Atlanta, US](http://www.itsmarta.com/app-developer-resources.aspx) | Marta | 아니요 | 아니요 | 알 수 없음 |
| [Transport for Auckland, New Zealand](https://api.at.govt.nz/) | Auckland Transport | 아니요 | 예 | 알 수 없음 |
| [Transport for Belgium](https://hello.irail.be/api/) | Belgian transport API | 아니요 | 예 | 알 수 없음 |
| [Transport for Berlin, Germany](https://github.com/derhuerst/vbb-rest/blob/master/docs/index.md) | Third-party VBB API | 아니요 | 예 | 알 수 없음 |
| [Transport for Bordeaux, France](https://opendata.bordeaux-metropole.fr/explore/) | Bordeaux Métropole public transport and more (France) | `apiKey` | 예 | 알 수 없음 |
| [Transport for Boston, US](https://mbta.com/developers/v3-api) | MBTA API | 아니요 | 아니요 | 알 수 없음 |
| [Transport for Budapest, Hungary](https://bkkfutar.docs.apiary.io) | Budapest public transport API | 아니요 | 예 | 알 수 없음 |
| [Transport for Chicago, US](http://www.transitchicago.com/developers/) | CTA | 아니요 | 아니요 | 알 수 없음 |
| [Transport for Czech Republic](https://www.chaps.cz/eng/products/idos-internet) | Czech transport API | 아니요 | 예 | 알 수 없음 |
| [Transport for Denver, US](http://www.rtd-denver.com/gtfs-developer-guide.shtml) | RTD | 아니요 | 아니요 | 알 수 없음 |
| [Transport for Finland](https://digitransit.fi/en/developers/ ) | Finnish transport API | 아니요 | 예 | 알 수 없음 |
| [Transport for Germany](http://data.deutschebahn.com/dataset/api-fahrplan) | Deutsche Bahn (DB) API | `apiKey` | 아니요 | 알 수 없음 |
| [Transport for Grenoble, France](https://www.metromobilite.fr/pages/opendata/OpenDataApi.html) | Grenoble public transport | 아니요 | 아니요 | 아니요 |
| [Transport for Honolulu, US](http://hea.thebus.org/api_info.asp) | Honolulu Transportation Information | `apiKey` | 아니요 | 알 수 없음 |
| [Transport for India](https://data.gov.in/sector/transport) | India Public Transport API | `apiKey` | 예 | 알 수 없음 |
| [Transport for Lisbon, Portugal](https://emel.city-platform.com/opendata/) | Data about buses routes, parking and traffic | `apiKey` | 예 | 알 수 없음 | 
| [Transport for London, England](https://api.tfl.gov.uk) | TfL API | 아니요 | 예 | 알 수 없음 |
| [Transport for Madrid, Spain](http://opendata.emtmadrid.es/Servicios-web/BUS) | Madrid BUS transport API | `apiKey` | 아니요 | 알 수 없음 |
| [Transport for Manchester, England](https://developer.tfgm.com/) | TfGM transport network data | `apiKey` | 예 | 아니요 |
| [Transport for Minneapolis, US](http://svc.metrotransit.org/) | NexTrip API | `OAuth` | 아니요 | 알 수 없음 |
| [Transport for New York City, US](http://datamine.mta.info/) | MTA | `apiKey` | 아니요 | 알 수 없음 |
| [Transport for Norway](http://reisapi.ruter.no/help) | Norwegian transport API | 아니요 | 아니요 | 알 수 없음 |
| [Transport for Ottawa, Canada](http://www.octranspo.com/index.php/developers) | OC Transpo next bus arrival API | 아니요 | 아니요 | 알 수 없음 |
| [Transport for Paris, France](http://restratpws.azurewebsites.net/swagger/) | Live schedules made simple | 아니요 | 아니요 | 알 수 없음 |
| [Transport for Paris, France](http://data.ratp.fr/api/v1/console/datasets/1.0/search/) | RATP Open Data API | 아니요 | 아니요 | 알 수 없음 |
| [Transport for Philadelphia, US](http://www3.septa.org/hackathon/) | SEPTA APIs | 아니요 | 아니요 | 알 수 없음 |
| [Transport for Sao Paulo, Brazil](http://www.sptrans.com.br/desenvolvedores/APIOlhoVivo/Documentacao.aspx) | SPTrans | `OAuth` | 아니요 | 알 수 없음 |
| [Transport for Sweden](https://www.trafiklab.se/api) | Public Transport consumer | `OAuth` | 예 | 알 수 없음 |
| [Transport for Switzerland](https://opentransportdata.swiss/en/) | Official Swiss Public Transport Open Data | `apiKey` | 예 | 알 수 없음 |
| [Transport for Switzerland](https://transport.opendata.ch/) | Swiss public transport API | 아니요 | 예 | 알 수 없음 |
| [Transport for The Netherlands](http://www.ns.nl/reisinformatie/ns-api) | NS, only trains | `apiKey` | 아니요 | 알 수 없음 |
| [Transport for The Netherlands](https://github.com/skywave/KV78Turbo-OVAPI/wiki) | OVAPI, country-wide public transport | 아니요 | 예 | 알 수 없음 |
| [Transport for Toronto, Canada](https://myttc.ca/developers) | TTC | 아니요 | 예 | 알 수 없음 |
| [Transport for United States](http://www.nextbus.com/xmlFeedDocs/NextBusXMLFeed.pdf) | NextBus API | 아니요 | 아니요 | 알 수 없음 |
| [Transport for Vancouver, Canada](https://developer.translink.ca/) | TransLink | `OAuth` | 예 | 알 수 없음 |
| [Transport for Victoria, AU](https://www.ptv.vic.gov.au/about-ptv/ptv-data-and-reports/digital-products/ptv-timetable-api/) | PTV API | `apiKey` | 예 | 알 수 없음 |
| [Transport for Washington, US](https://developer.wmata.com/) | Washington Metro transport API | `OAuth` | 예 | 알 수 없음 |
| [Uber](https://developer.uber.com/products) | Uber ride requests and price estimation | `OAuth` | 예 | 예 |
| [WhereIsMyTransport](https://developer.whereismytransport.com/) | Platform for public transport data in emerging cities | `OAuth` | 예 | 알 수 없음 |
...
API | 설명 | 인증 | HTTPS | CORS |
|---|---|---|---|---|
| [7Timer!](http://www.7timer.info/doc.php?lang=en) | Weather, especially for Astroweather | 아니요 | 아니요 | 알 수 없음 |
| [APIXU](https://www.apixu.com/doc/request.aspx) | Weather | `apiKey` | 예 | 알 수 없음 |
| [Dark Sky](https://darksky.net/dev/) | Weather | `apiKey` | 예 | 아니요 |
| [MetaWeather](https://www.metaweather.com/api/) | Weather | 아니요 | 예 | 아니요 |
| [Meteorologisk Institutt](https://api.met.no/weatherapi/documentation) | Weather and climate data | 아니요 | 예 | 알 수 없음 |
| [NOAA Climate Data](https://www.ncdc.noaa.gov/cdo-web/) | Weather and climate data | `apiKey` | 예 | 알 수 없음 |
| [ODWeather](http://api.oceandrivers.com/static/docs.html) | Weather and weather webcams | 아니요 | 아니요 | 알 수 없음 |
| [OpenUV](https://www.openuv.io) | Real-time UV Index Forecast | `apiKey` | 예 | 알 수 없음 |
| [OpenWeatherMap](http://openweathermap.org/api) | Weather | `apiKey` | 아니요 | 알 수 없음 |
| [Storm Glass](https://stormglass.io/) | Global marine weather from multiple sources | `apiKey` | 예 | 예 |
| [Weatherbit](https://www.weatherbit.io/api) | Weather | `apiKey` | 예 | 알 수 없음 |
