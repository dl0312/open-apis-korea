...
| API                                                                                                                    | 설명                                                                                 | 인증     | HTTPS      | CORS       |
| ---------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------ | -------- | ---------- | ---------- |
| [adresse.data.gouv.fr](https://adresse.data.gouv.fr)                                                                   | 프랑스의 주소 데이터베이스                                                           | 아니요   | 예         | 알 수 없음 |
| [Battuta](http://battuta.medunes.net)                                                                                  | 나의 국가/지역/도시 위치 API                                                         | `apiKey` | 아니요     | 알 수 없음 |
| [Bing Maps](https://www.microsoft.com/maps/)                                                                           | 빙 지도 데이터를 기반으로 디지털 맵을 생성/사용자화합니다.                           | `apiKey` | 예         | 알 수 없음 |
| [bng2latlong](https://www.getthedata.com/bng2latlong)                                                                  | 영국 OSGB36 Easting 및 Northing(영국 국가 그리드)을 WGS84 위도 및 경도로 변환합니다. | 아니요   | 예         | 예         |
| [CitySDK](http://www.citysdk.eu/citysdk-toolkit/)                                                                      | 유럽 도시 오픈 API                                                                   | 아니요   | 예         | 알 수 없음 |
| [Kakao Maps API](http://apis.map.kakao.com/)                                                                           | 카카오 지도 API는 웹사이트와 모바일 애플리케이션에서                                 |
| 지도를 이용한 서비스를 제작할 수 있도록 다양한 기능을 제공하고 있습니다.                                               | `apiKey`                                                                             | 아니요   | 알 수 없음 |
| [FreeGeoIP](https://freegeoip.app/)                                                                                    | 등록할 필요가 없는 무료 Geo IP 정보입니다. 시간당 15k 속도 제한                      | 아니요   | 예         | 예         |
| [GeoApi](https://api.gouv.fr/api/geoapi.html)                                                                          | 프랑스 지리 자료                                                                     | 아니요   | 예         | 알 수 없음 |
| [Geocod.io](https://www.geocod.io/)                                                                                    | 대량으로 지오코딩/역방향 지오코딩을 처리합니다.                                      | `apiKey` | 예         | 알 수 없음 |
| [Geocode.xyz](https://geocode.xyz/)                                                                                    | 전 세계 전방/후방 지리적 코드화, 배치 지리적 코드화 및 지구적 특성을 제공합니다.     | 아니요   | 예         | 알 수 없음 |
| [GeoDataSource](https://www.geodatasource.com/web-service)                                                             | 위도 및 경도 좌표를 사용하여 도시 이름을 지오코딩합니다.                             | `apiKey` | 예         | 알 수 없음 |
| [GeoJS](https://geojs.io/)                                                                                             | ChatOps 통합을 통한 IP 지오로케이션                                                  | 아니요   | 예         | 예         |
| [GeoNames](http://www.geonames.org/export/web-services.html)                                                           | 장소 이름 및 기타 지리적 데이터                                                      | 아니요   | 아니요     | 알 수 없음 |
| [geoPlugin](https://www.geoplugin.com)                                                                                 | IP 지리위치정보 및 통화 변환                                                         | 아니요   | 예         | 예         |
| [Google Earth Engine](https://developers.google.com/earth-engine/)                                                     | 행성 규모의 환경 데이터 분석을 위한 클라우드 기반 플랫폼                             | `apiKey` | 예         | 알 수 없음 |
| [Google Maps](https://developers.google.com/maps/)                                                                     | 구글 지도 데이터를 기반으로 디지털 맵을 만들고 사용자화합니다.                       | `apiKey` | 예         | 알 수 없음 |
| [HelloSalut](https://www.fourtonfish.com/hellosalut/hello/)                                                            | 사용자 언어에 따라 "Hello"에 대한 변역을 얻습니다.                                   | 아니요   | 예         | 알 수 없음 |
| [HERE Maps](https://developer.here.com)                                                                                | HERE의 지도 데이터를 기반으로 디지털 맵을 생성하고 사용자화합니다.                   | `apiKey` | 예         | 알 수 없음 |
| [Indian Cities](https://indian-cities-api-nocbegfhqg.now.sh/)                                                          | 모든 인도 도시를 깔끔한 JSON 형식으로 얻습니다.                                      | 아니요   | 예         | 예         |
| [IP 2 Country](https://ip2country.info)                                                                                | IP를 국가에 매핑합니다.                                                              | 아니요   | 예         | 알 수 없음 |
| [IP Address Details](https://ipinfo.io/)                                                                               | IP 주소를 사용하여 지리 위치를 찾습니다.                                             | 아니요   | 예         | 알 수 없음 |
| [IP Location](http://ip-api.com/)                                                                                      | IP 주소가 있는 위치를 찾습니다.                                                      | 아니요   | 아니요     | 알 수 없음 |
| [IP Location](https://ipapi.co/)                                                                                       | IP 주소 위치 정보를 찾습니다.                                                        | 아니요   | 예         | 알 수 없음 |
| [IP Sidekick](https://ipsidekick.com)                                                                                  | IP 주소에 대한 추가 정보를 반환하는 지리위치정보 API입니다.                          | `apiKey` | 예         | 알 수 없음 |
| [IP Vigilante](https://www.ipvigilante.com/)                                                                           | 무료 IP 지리위치정보 API                                                             | 아니요   | 예         | 알 수 없음 |
| [IP2Location](https://www.ip2location.com/web-service/ip2location)                                                     | 55개 이상의 인자를 얻을 수 있는 IP 지리위치정보 웹 서비스                            | `apiKey` | 예         | 알 수 없음 |
| [IP2Proxy](https://www.ip2location.com/web-service/ip2proxy)                                                           | IP 주소를 사용하여 프록시 및 VPN을 검색합니다.                                       | `apiKey` | 예         | 알 수 없음 |
| [IPGeolocationAPI.com](https://ipgeolocationapi.com/)                                                                  | 국가 세부 정보가 포함된 IP를 통해 방문자를 찾습니다.                                 | 아니요   | 예         | 예         |
| [IPInfoDB](https://ipinfodb.com/api)                                                                                   | IP 주소로 국가, 지역, 도시 및 시간대 조회를 위한 무료 지역위치정보 도구와 API        | `apiKey` | 예         | 알 수 없음 |
| [ipstack](https://ipstack.com/)                                                                                        | IP 주소로 웹 사이트 방문자를 찾아 식별합니다.                                        | `apiKey` | 예         | 알 수 없음 |
| [Kwelo Network](https://www.kwelo.com/network/ip-address)                                                              | IP 주소에 대한 자세한 정보를 찾아 가져옵니다.                                        | 아니요   | 예         | 예         |
| [LocationIQ](https://locationiq.org/docs/)                                                                             | 전진/후진 지역위치정보 및 집단 지역위치정보를 제공합니다.                            | `apiKey` | 예         | 예         |
| [Mapbox](https://www.mapbox.com/developers/)                                                                           | 아름다운 디지털 맵을 만들거나 사용자화합니다.                                        | `apiKey` | 예         | 알 수 없음 |
| [Mexico](https://github.com/IcaliaLabs/sepomex)                                                                        | 멕시코 RESTful zip code API                                                          | 아니요   | 예         | 알 수 없음 |
| [One Map, Singapore](https://docs.onemap.sg/)                                                                          | 싱가포르 주소용 싱가포르 토지 당국 REST API 서비스                                   | `apiKey` | 예         | 알 수 없음 |
| [OnWater](https://onwater.io/)                                                                                         | 위도/경도가 물 위에 있는지 또는 육지에 있는지 확인합니다.                            | 아니요   | 예         | 알 수 없음 |
| [OpenCage](https://opencagedata.com)                                                                                   | 열린 데이터를 사용하여 지역위치정보를 확인합니다.                                    | `apiKey` | 예         | 예         |
| [OpenStreetMap](http://wiki.openstreetmap.org/wiki/API)                                                                | 탐색, 지리 위치 및 지리적 데이터                                                     | `OAuth`  | 아니요     | 알 수 없음 |
| [PostcodeData.nl](http://api.postcodedata.nl/v1/postcode/?postcode=1211EP&streetnumber=60&ref=domeinnaam.nl&type=json) | 네덜란드어 주소의 우편 번호를 기준으로 지리 위치 데이터를 제공합니다.                | 아니요   | 아니요     | 알 수 없음 |
| [Postcodes.io](https://postcodes.io)                                                                                   | 영국의 우편 번호 조회 및 지역위치정보                                                | 아니요   | 예         | 예         |
| [REST Countries](https://restcountries.eu)                                                                             | RESTful API를 통해 국가 정보를 얻습니다.                                             | 아니요   | 예         | 알 수 없음 |
| [SmartIP.io](https://smartip.io)                                                                                       | IP 지역위치정보 및 위협 지능 API                                                     | `apiKey` | 예         | 예         |
| [Uebermaps](https://uebermaps.com/api/v2)                                                                              | 지도를 검색하고 친구들과 공유합니다.                                                 | `apiKey` | 예         | 알 수 없음 |
| [US ZipCode](https://smartystreets.com/docs/cloud/us-zipcode-api)                                                      | US Zip Code에 대한 데이터를 확인하고 추가합니다.                                     | `apiKey` | 예         | 예         |
| [Utah AGRC](https://api.mapserv.utah.gov)                                                                              | 유타 주소 지역위치정보를 위한 유타 웹 API                                            | `apiKey` | 예         | 알 수 없음 |
| [ViaCep](https://viacep.com.br)                                                                                        | 브라질의 우편번호 API                                                                | 아니요   | 예         | 알 수 없음 |
| [ZipCodeAPI](https://www.zipcodeapi.com)                                                                               | 미국 우편 번호 거리, 반경 및 위치 API                                                | `apiKey` | 예         | 알 수 없음 |
| [Zippopotam](http://www.zippopotam.us)                                                                                 | 국가, 도시, 주 등의 장소에 대한 정보를 얻습니다.                                     | 아니요   | 아니요     | 알 수 없음 |
