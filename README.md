...
| API                                                                    | 설명                                                                                      | 인증     | HTTPS | CORS       |
| ---------------------------------------------------------------------- | ----------------------------------------------------------------------------------------- | -------- | ----- | ---------- |
| [Buffer](https://buffer.com/developers/api)                            | 버퍼에서 보류 중이거나 전송된 업데이트에 접근합니다.                                      | `OAuth`  | 예    | 알 수 없음 |
| [Cisco Spark](https://developer.ciscospark.com)                        | 팀 공동 작업 소프트웨어                                                                   | `OAuth`  | 예    | 알 수 없음 |
| [Discord](https://discordapp.com/developers/docs/intro)                | Discord용 봇를 만들고 Discord를 외부 플랫폼에 통합합니다.                                 | `OAuth`  | 예    | 알 수 없음 |
| [Disqus](https://disqus.com/api/docs/auth/)                            | Disqus 데이터와 통신합니다.                                                               | `OAuth`  | 예    | 알 수 없음 |
| [Facebook](https://developers.facebook.com/)                           | 페이스북 로그인, 페이스북 공유, 소셜 플러그인, 분석 등                                    | `OAuth`  | 예    | 알 수 없음 |
| [Foursquare](https://developer.foursquare.com/)                        | 포스퀘어 사용자 및 장소(지오로케이션 기반 체크인, 사진, 팁, 이벤트 등)와 상호 작용합니다. | `OAuth`  | 예    | 알 수 없음 |
| [Fuck Off as a Service](https://www.foaas.com)                         | 누군가에게 꺼져달라고 요청합니다.                                                         | 아니요   | 예    | 알 수 없음 |
| [Full Contact](https://www.fullcontact.com/developer/docs/)            | 소셜 미디어 프로필 및 연락처 정보를 가져옵니다.                                           | `OAuth`  | 예    | 알 수 없음 |
| [HackerNews](https://github.com/HackerNews/API)                        | 컴퓨터 공학와 기업가 정신을 위한 소셜 뉴스                                                | 아니요   | 예    | 알 수 없음 |
| [Instagram](https://www.instagram.com/developer/)                      | 인스타그램 로그인, 인스타그램에 공유, 소셜 플러그인 등                                    | `OAuth`  | 예    | 알 수 없음 |
| [LinkedIn](https://developer.linkedin.com/docs/rest-api)               | 모든 디지털 통합의 기반, 링크드인                                                         | `OAuth`  | 예    | 알 수 없음 |
| [Meetup.com](https://www.meetup.com/meetup_api/)                       | Meetup.com의 모임 데이터                                                                  | `apiKey` | 예    | 알 수 없음 |
| [Mixer](https://dev.mixer.com/)                                        | 게임 스트리밍 API                                                                         | `OAuth`  | 예    | 알 수 없음 |
| [MySocialApp](https://mysocialapp.io)                                  | 모든 앱에 원활한 소셜 네트워킹 기능, API, SDK를 제공합니다.                               | `apiKey` | 예    | 알 수 없음 |
| [Open Collective](https://docs.opencollective.com/help/developers/api) | Open Collective 데이터를 가져옵니다.                                                      | 아니요   | 예    | 알 수 없음 |
| [Pinterest](https://developers.pinterest.com/)                         | 세계의 아이디어 목록                                                                      | `OAuth`  | 예    | 알 수 없음 |
| [PWRTelegram bot](https://pwrtelegram.xyz)                             | 텔레그램 봇 API 업그레이드 버전                                                           | `OAuth`  | 예    | 알 수 없음 |
...
| API                                                                   | 설명                                        | 인증     | HTTPS | CORS       |
| --------------------------------------------------------------------- | ------------------------------------------- | -------- | ----- | ---------- |
| [Best Buy](https://bestbuyapis.github.io/api-documentation/#overview) | 제품, 구매 옵션, 범주, 추천, 상점 및 커머스 | `apiKey` | 예    | 알 수 없음 |
| [Bratabase](https://developers.bratabase.com/)                        | 다양한 종류의 브라 사이즈 데이터베이스      | `OAuth`  | 예    | 알 수 없음 |
| [eBay](https://go.developer.ebay.com/)                                | 이베이를 통해 물건을 사고 팝니다.           | `OAuth`  | 예    | 알 수 없음 |
| [Wal-Mart](https://developer.walmartlabs.com/docs)                    | 월마트의 물건 가격과 다양한 정보            | `apiKey` | 예    | 알 수 없음 |
| [Wegmans](https://dev.wegmans.io)                                     | 웨그먼스 푸드마켓                           | `apiKey` | 예    | 알 수 없음 |
