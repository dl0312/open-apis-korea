...
| [IPinfo](https://ipinfo.io/developers)                                                              | 간단한 IP 주소                                                                                                     | ❌              | ✅    | 알 수 없음 |
...
| [StackExchange](https://api.stackexchange.com/)                                                     | 개발자들을 위한 Q&A 포럼                                                                                           | `OAuth`         | ✅    | 알 수 없음 |
...
| [Guild Wars 2](https://wiki.guildwars2.com/wiki/API:Main)         | 길드 워 2 정보                                                         | `apiKey`        | ✅    | 알 수 없음 |
...
| [Minor Planet Center](http://www.asterank.com/mpc)                             | Asterank.com 정보                                                              | ❌       | ❌    | 알 수 없음 |
...
| [REFUGE Restrooms](https://www.refugerestrooms.org/api/docs/#!/restrooms)                                                   | 트랜스젠더, 인터섹스에게 안전한 화장실 정보를 제공합니다.       | ❌       | ✅    | 알 수 없음 |
...
| [Transport for Sao Paulo, Brazil](http://www.sptrans.com.br/desenvolvedores/APIOlhoVivo/Documentacao.aspx)                  | 브라질 상파울로 교통                                            | `OAuth`  | ❌    | 알 수 없음 |
...
| [YouTube](https://developers.google.com/youtube/)                                                  | 사이트 및 앱에 YouTube 기능을 추가합니다.           | `OAuth`         | ✅    | 알 수 없음 |
...
| [PWRTelegram bot](https://pwrtelegram.xyz)                             | 텔레그램 봇 API 업그레이드 버전                                                           | `OAuth`  | ✅    | 알 수 없음 |
...
| [NHL Records and Stats](https://gitlab.com/dword4/nhlapi)                    | NHL 기록 데이터 및 통계                                                    | ❌              | ✅    | 알 수 없음 |
...
| [Yelp](https://www.yelp.com/developers/documentation/v3)                    | 로컬 비즈니스를 찾습니다.                                                                 | `OAuth`         | ✅    | 알 수 없음 |
...
| API                                                     | 설명                            | 인증     | HTTPS | CORS       |
| ------------------------------------------------------- | ------------------------------- | -------- | ----- | ---------- |
| [Countly](http://resources.count.ly/docs)               | 카우틀리 웹 분석                | ❌       | ❌    | 알 수 없음 |
| [Drupal.org](https://www.drupal.org/drupalorg/docs/api) | Drupal.org                      | ❌       | ✅    | 알 수 없음 |
| [Evil Insult Generator](https://evilinsult.com/api)     | 악마의 모욕                     | ❌       | ✅    | ✅         |
| [Libraries.io](https://libraries.io/api)                | 오픈 소스 소프트웨어 라이브러리 | `apiKey` | ✅    | 알 수 없음 |
...
| API                                                                              | 설명                               | 인증     | HTTPS | CORS       |
| -------------------------------------------------------------------------------- | ---------------------------------- | -------- | ----- | ---------- |
| [Edamam](https://developer.edamam.com/)                                          | 레시피 검색                        | `apiKey` | ✅    | 알 수 없음 |
| [LCBO](https://lcboapi.com/)                                                     | 알코올                             | `apiKey` | ✅    | 알 수 없음 |
| [Open Brewery DB](https://www.openbrewerydb.org)                                 | 맥주, 사이다, 크래프트 맥주병 가게 | ❌       | ✅    | ✅         |
| [Open Food Facts](https://world.openfoodfacts.org/data)                          | 식품 데이터베이스                  | ❌       | ✅    | 알 수 없음 |
| [PunkAPI](https://punkapi.com/)                                                  | 브루독 맥주 레시피                 | ❌       | ✅    | 알 수 없음 |
| [Recipe Puppy](http://www.recipepuppy.com/about/api/)                            | 음식                               | ❌       | ❌    | 알 수 없음 |
| [TacoFancy](https://github.com/evz/tacofancy-api)                                | 커뮤니티 기반 타코 데이터베이스    | ❌       | ❌    | 알 수 없음 |
| [The Report of the Week](https://github.com/andyklimczak/TheReportOfTheWeek-API) | 음식 & 음료수 리뷰                 | ❌       | ✅    | 알 수 없음 |
| [TheCocktailDB](https://www.thecocktaildb.com/api.php)                           | 칵테일 레시피                      | `apiKey` | ✅    | ✅         |
| [TheMealDB](https://www.themealdb.com/api.php)                                   | 요리 레시피                        | `apiKey` | ✅    | ✅         |
| [What's on the menu?](http://nypl.github.io/menus-api/)                          | NYPL 역사적 메뉴 모음 NYPL         | `apiKey` | ❌    | 알 수 없음 |
| [Zomato](https://developers.zomato.com/api)                                      | 음식점을 찾아보세요.               | `apiKey` | ✅    | 알 수 없음 |
...
| [Bandsintown](https://app.swaggerhub.com/apis/Bandsintown/PublicAPI/3.0.0)                                       | 음악 행사                                                                               | ❌       | ✅    | 알 수 없음 |
| [Deezer](https://developers.deezer.com/api)                                                                      | 음악                                                                                    | `OAuth`  | ✅    | 알 수 없음 |
| [Discogs](https://www.discogs.com/developers/)                                                                   | 음악                                                                                    | `OAuth`  | ✅    | 알 수 없음 |
| [Genius](https://docs.genius.com/)                                                                               | 풍부한 가사와 음악 지식                                                                 | `OAuth`  | ✅    | 알 수 없음 |
| [Genrenator](https://binaryjazz.us/genrenator-api/)                                                              | 음악 장르 생성기                                                                        | ❌       | ✅    | 알 수 없음 |
| [iTunes Search](https://affiliate.itunes.apple.com/resources/documentation/itunes-store-web-service-search-api/) | 소프트웨어 제품                                                                         | ❌       | ✅    | 알 수 없음 |
| [Jamendo](https://developer.jamendo.com/v3.0/docs)                                                               | 음악                                                                                    | `OAuth`  | ✅    | 알 수 없음 |
| [KKBOX](https://developer.kkbox.com)                                                                             | KKBOX 플랫폼에서 음악 라이브러리, 재생 목록, 차트 및 공연을 가져옵니다.                 | `OAuth`  | ✅    | 알 수 없음 |
| [LastFm](https://www.last.fm/api)                                                                                | 음악                                                                                    | `apiKey` | ✅    | 알 수 없음 |
| [Lyrics.ovh](http://docs.lyricsovh.apiary.io/)                                                                   | 노래 가사를 검색하는 간단한 API                                                         | ❌       | ✅    | 알 수 없음 |
| [Mixcloud](https://www.mixcloud.com/developers/)                                                                 | 음악                                                                                    | `OAuth`  | ✅    | ✅         |
| [MusicBrainz](https://musicbrainz.org/doc/Development/XML_Web_Service/Version_2)                                 | 음악                                                                                    | ❌       | ✅    | 알 수 없음 |
| [Musikki](https://music-api.musikki.com/reference)                                                               | 음악                                                                                    | `apiKey` | ✅    | 알 수 없음 |
| [Musixmatch](https://developer.musixmatch.com/)                                                                  | 음악                                                                                    | `apiKey` | ✅    | 알 수 없음 |
| [Openwhyd](https://openwhyd.github.io/openwhyd/API)                                                              | 스트리밍 트랙의 큐레이션된 재생 목록(YouTube, SoundCloud 등)을 다운로드합니다.          | `❌`     | ✅    | ❌         |
| [Songkick](https://www.songkick.com/developer/)                                                                  | 음악 행사                                                                               | `OAuth`  | ✅    | 알 수 없음 |
| [Songsterr](https://www.songsterr.com/a/wa/api/)                                                                 | 기타, 베이스 및 드럼 탭과 코드를 제공합니다.                                            | ❌       | ✅    | 알 수 없음 |
| [SoundCloud](https://developers.soundcloud.com/)                                                                 | 사용자가 소리를 업로드하고 공유합니다.                                                  | `OAuth`  | ✅    | 알 수 없음 |
| [Spotify](https://beta.developer.spotify.com/documentation/web-api/)                                             | 스포티파이의 음악 카탈로그 지정, 사용자 라이브러리 관리, 권장 사항 등을 볼 수 있습니다. | `OAuth`  | ✅    | 알 수 없음 |
| [TasteDive](https://tastedive.com/read/api)                                                                      | 유사한 아티스트 API(영화 및 TV 프로그램에도 적용됩니다)                                 | `apiKey` | ✅    | 알 수 없음 |
| [TheAudioDB](https://www.theaudiodb.com/api_guide.php)                                                           | 음악                                                                                    | `apiKey` | ✅    | 알 수 없음 |
| [Vagalume](https://api.vagalume.com.br/docs/)                                                                    | 풍부한 가사와 음악 지식                                                                 | `apiKey` | ✅    | 알 수 없음 |
...
| API                                                                       | 설명                                                                   | 인증     | HTTPS | CORS       |
| ------------------------------------------------------------------------- | ---------------------------------------------------------------------- | -------- | ----- | ---------- |
| [Advice Slip](http://api.adviceslip.com/)                                 | 임의의 advice slips을 생성합니다.                                      | ❌       | ✅    | 알 수 없음 |
| [chucknorris.io](https://api.chucknorris.io)                              | 직접 큐레이션한 척 노리스 농담 JSON API                                | ❌       | ✅    | 알 수 없음 |
| [FavQs.com](https://favqs.com/api)                                        | 좋아하는 인용구를 수집, 검색 및 공유할 수 있습니다.                    | `apiKey` | ✅    | 알 수 없음 |
| [FOAAS](http://www.foaas.com/)                                            | **F**uck **O**ff **A**s **A** **S**ervice                              | ❌       | ❌    | 알 수 없음 |
| [Forismatic](http://forismatic.com/en/api/)                               | 영감을 주는 명언                                                       | ❌       | ❌    | 알 수 없음 |
| [icanhazdadjoke](https://icanhazdadjoke.com/api)                          | 인터넷의 미국식 아재 농담 모음                                         | ❌       | ✅    | 알 수 없음 |
| [kanye.rest](https://kanye.rest)                                          | 칸예 웨스트 인용구 REST API                                            | ❌       | ✅    | ✅         |
| [Medium](https://github.com/Medium/medium-api-docs)                       | 독자와 아이디어에 대한 독특한 관점을 제공하는 독자와 작가들의 커뮤니티 | `OAuth`  | ✅    | 알 수 없음 |
| [NaMoMemes](https://github.com/theIYD/NaMoMemes)                          | 나렌드라 모디 밈                                                       | ❌       | ✅    | 알 수 없음 |
| [Programming Quotes](https://github.com/skolakoda/programming-quotes-api) | 오픈 소스 프로젝트를 위한 프로그래밍 인용구 API                        | ❌       | ✅    | 알 수 없음 |
| [Quote Garden](https://pprathameshmore.github.io/QuoteGarden/)            | 5000개 이상의 유명한 인용구를 제공하는 REST API                        | ❌       | ✅    | 알 수 없음 |
| [Quotes on Design](https://quotesondesign.com/api/)                       | 영감을 주는 인용구                                                     | ❌       | ✅    | 알 수 없음 |
| [Traitify](https://app.traitify.com/developer)                            | 성격을 평가, 수집 및 분석합니다.                                       | ❌       | ✅    | 알 수 없음 |
| [tronalddump.io](https://www.tronalddump.io)                              | 도널드 트럼프 대통령이 말한 것들에 대한 API & 웹 아카이브입니다.       | ❌       | ✅    | 알 수 없음 |
...
| API                                                                                 | 설명                                                                                   | 인증     | HTTPS | CORS       |
| ----------------------------------------------------------------------------------- | -------------------------------------------------------------------------------------- | -------- | ----- | ---------- |
| [BCLaws](http://www.bclaws.ca/civix/template/complete/api/index.html)               | 브리티시 컬럼비아의 법칙에 접근합니다.                                                 | ❌       | ❌    | 알 수 없음 |
| [BusinessUSA](https://business.usa.gov/developer)                                   | 미국 프로그램, 이벤트, 서비스 등에 대한 권한 있는 정보                                 | `apiKey` | ✅    | 알 수 없음 |
| [Census.gov](https://www.census.gov/data/developers/data-sets.html)                 | 미국 인구조사국에서 인구통계 및 비즈니스에 대한 다양한 API와 데이터 세트를 제공합니다. | ❌       | ✅    | 알 수 없음 |
| [City, Lyon Opendata](https://data.beta.grandlyon.com/fr/accueil)                   | 프랑스 리옹의 오픈 데이터                                                              | `apiKey` | ✅    | 알 수 없음 |
| [City, Nantes Opendata](https://data.nantesmetropole.fr/pages/home/)                | 프랑스 낭트의 오픈 데이터                                                              | `apiKey` | ✅    | 알 수 없음 |
| [City, Prague Opendata](http://opendata.praha.eu/en)                                | 체코 프라하의 오픈 데이터                                                              | ❌       | ❌    | 알 수 없음 |
| [Code.gov](https://code.gov)                                                        | 미국 연방 정부를 위한 오픈 소스 및 코드 공유를 위한 플랫폼                             | `apiKey` | ✅    | 알 수 없음 |
| [Colorado Data Engine](http://codataengine.org/)                                    | 콜로라도의 공개 데이터                                                                 | ❌       | ✅    | 알 수 없음 |
| [Colorado Information Marketplace](https://data.colorado.gov/)                      | 콜로라도 주립 정부 오픈 데이터                                                         | ❌       | ✅    | 알 수 없음 |
| [Data USA](https://datausa.io/about/api/)                                           | 미국 공공 데이터                                                                       | ❌       | ✅    | 알 수 없음 |
| [Data.gov](https://api.data.gov/)                                                   | 미국 정부 데이터                                                                       | `apiKey` | ✅    | 알 수 없음 |
| [Data.parliament.uk](http://www.data.parliament.uk/developers/)                     | 탄원서, 청구서, MP 투표, 참석 등에 대한 정보를 포함한 실시간 데이터 세트               | ❌       | ❌    | 알 수 없음 |
| [District of Columbia Open Data](http://opendata.dc.gov/pages/using-apis)           | 범죄, GIS, 재무 데이터 등을 포함한 D.C. 정부 공공 데이터셋                             | ❌       | ✅    | 알 수 없음 |
| [EPA](https://developer.epa.gov/category/apis/)                                     | 미국 환경 보호국에서 제공하는 웹 서비스와 데이터 세트                                  | ❌       | ✅    | 알 수 없음 |
| [FEC](https://api.open.fec.gov/developers/)                                         | 연방 선거의 선거 기부에 대한 정보                                                      | `apiKey` | ✅    | 알 수 없음 |
| [Federal Register](https://www.federalregister.gov/reader-aids/developer-resources) | 미국 정부의 데일리 저널                                                                | ❌       | ✅    | 알 수 없음 |
| [Food Standards Agency](http://ratings.food.gov.uk/open-data/en-GB)                 | 영국 음식 위생 등급 데이터 API                                                         | ❌       | ❌    | 알 수 없음 |
| [Open Government, Australia](https://www.data.gov.au/)                              | 호주 정부 오픈 데이터                                                                  | ❌       | ✅    | 알 수 없음 |
| [Open Government, Belgium](https://data.gov.be/)                                    | 벨기에 정부 오픈 데이터                                                                | ❌       | ✅    | 알 수 없음 |
| [Open Government, Canada](http://open.canada.ca/en)                                 | 캐나다 정부 오픈 데이터                                                                | ❌       | ❌    | 알 수 없음 |
| [Open Government, France](https://www.data.gouv.fr/)                                | 프랑스 정부 오픈 데이터                                                                | `apiKey` | ✅    | 알 수 없음 |
| [Open Government, India](https://data.gov.in/)                                      | 인도 정부 오픈 데이터                                                                  | `apiKey` | ✅    | 알 수 없음 |
| [Open Government, Italy](https://www.dati.gov.it/)                                  | 이탈리아 정부 오픈 데이터                                                              | ❌       | ✅    | 알 수 없음 |
| [Open Government, New Zealand](https://www.data.govt.nz/)                           | 뉴질랜드 정부 오픈 데이터                                                              | ❌       | ✅    | 알 수 없음 |
| [Open Government, Romania](http://data.gov.ro/)                                     | 루마니아 정부 오픈 데이터                                                              | ❌       | ❌    | 알 수 없음 |
| [Open Government, Taiwan](https://data.gov.tw/)                                     | 대만 정부 오픈 데이터                                                                  | ❌       | ✅    | 알 수 없음 |
| [Open Government, USA](https://www.data.gov/)                                       | 미국 정부 오픈 데이터                                                                  | ❌       | ✅    | 알 수 없음 |
| [Regulations.gov](https://regulationsgov.github.io/developers/)                     | 연방 규칙 제정 과정에 대한 이해를 높이기 위한 연방 규제 자료                           | `apiKey` | ✅    | 알 수 없음 |
| [Represent by Open North](https://represent.opennorth.ca/)                          | 캐나다 정부 대표자를 찾습니다.                                                         | ❌       | ✅    | 알 수 없음 |
| [USAspending.gov](https://api.usaspending.gov/)                                     | 미국 연방 지출 데이터                                                                  | ❌       | ✅    | 알 수 없음 |
...
| API                                                     | 설명                                                                      | 인증     | HTTPS | CORS       |
| ------------------------------------------------------- | ------------------------------------------------------------------------- | -------- | ----- | ---------- |
| [CircleCI](https://circleci.com/docs/api/v1-reference/) | 지속적 통합과 지속적 전달을 이용한 소프트웨어 개발 과정 자동화            | `apiKey` | ✅    | 알 수 없음 |
| [Codeship](https://apidocs.codeship.com/)               | 코드쉽은 클라우드에 있는 지속적 통합 플랫폼입니다.                        | `apiKey` | ✅    | 알 수 없음 |
| [Travis CI](https://docs.travis-ci.com/api/)            | 즉시, 코드를 테스트하기위해 GitHub 프로젝트를 트레비스 CI로 동기화합니다. | `apiKey` | ✅    | 알 수 없음 |
...
| API                                                                                                                    | 설명                                                                                                                          | 인증     | HTTPS | CORS       |
| ---------------------------------------------------------------------------------------------------------------------- | ----------------------------------------------------------------------------------------------------------------------------- | -------- | ----- | ---------- |
| [adresse.data.gouv.fr](https://adresse.data.gouv.fr)                                                                   | 프랑스의 주소 데이터베이스                                                                                                    | ❌       | ✅    | 알 수 없음 |
| [Battuta](http://battuta.medunes.net)                                                                                  | 나의 국가/지역/도시 위치 API                                                                                                  | `apiKey` | ❌    | 알 수 없음 |
| [Bing Maps](https://www.microsoft.com/maps/)                                                                           | 빙 지도 데이터를 기반으로 디지털 맵을 생성/사용자화합니다.                                                                    | `apiKey` | ✅    | 알 수 없음 |
| [bng2latlong](https://www.getthedata.com/bng2latlong)                                                                  | 영국 OSGB36 Easting 및 Northing(영국 국가 그리드)을 WGS84 위도 및 경도로 변환합니다.                                          | ❌       | ✅    | ✅         |
| [CitySDK](http://www.citysdk.eu/citysdk-toolkit/)                                                                      | 유럽 도시 오픈 API                                                                                                            | ❌       | ✅    | 알 수 없음 |
| [Kakao Maps](http://apis.map.kakao.com/)                                                                               | 카카오 지도 API는 웹사이트와 모바일 애플리케이션에서 지도를 이용한 서비스를 제작할 수 있도록 다양한 기능을 제공하고 있습니다. | `apiKey` | ❌    | 알 수 없음 |
| [FreeGeoIP](https://freegeoip.app/)                                                                                    | 등록할 필요가 없는 무료 Geo IP 정보입니다. 시간당 15k 속도 제한                                                               | ❌       | ✅    | ✅         |
| [GeoApi](https://api.gouv.fr/api/geoapi.html)                                                                          | 프랑스 지리 자료                                                                                                              | ❌       | ✅    | 알 수 없음 |
| [Geocod.io](https://www.geocod.io/)                                                                                    | 대량으로 지오코딩/역방향 지오코딩을 처리합니다.                                                                               | `apiKey` | ✅    | 알 수 없음 |
| [Geocode.xyz](https://geocode.xyz/)                                                                                    | 전 세계 전방/후방 지리적 코드화, 배치 지리적 코드화 및 지구적 특성을 제공합니다.                                              | ❌       | ✅    | 알 수 없음 |
| [GeoDataSource](https://www.geodatasource.com/web-service)                                                             | 위도 및 경도 좌표를 사용하여 도시 이름을 지오코딩합니다.                                                                      | `apiKey` | ✅    | 알 수 없음 |
| [GeoJS](https://geojs.io/)                                                                                             | ChatOps 통합을 통한 IP 지오로케이션                                                                                           | ❌       | ✅    | ✅         |
| [GeoNames](http://www.geonames.org/export/web-services.html)                                                           | 장소 이름 및 기타 지리적 데이터                                                                                               | ❌       | ❌    | 알 수 없음 |
| [geoPlugin](https://www.geoplugin.com)                                                                                 | IP 지리위치정보 및 통화 변환                                                                                                  | ❌       | ✅    | ✅         |
| [Google Earth Engine](https://developers.google.com/earth-engine/)                                                     | 행성 규모의 환경 데이터 분석을 위한 클라우드 기반 플랫폼                                                                      | `apiKey` | ✅    | 알 수 없음 |
| [Google Maps](https://developers.google.com/maps/)                                                                     | 구글 지도 데이터를 기반으로 디지털 맵을 만들고 사용자화합니다.                                                                | `apiKey` | ✅    | 알 수 없음 |
| [HelloSalut](https://www.fourtonfish.com/hellosalut/hello/)                                                            | 사용자 언어에 따라 "Hello"에 대한 변역을 얻습니다.                                                                            | ❌       | ✅    | 알 수 없음 |
| [HERE Maps](https://developer.here.com)                                                                                | HERE의 지도 데이터를 기반으로 디지털 맵을 생성하고 사용자화합니다.                                                            | `apiKey` | ✅    | 알 수 없음 |
| [Indian Cities](https://indian-cities-api-nocbegfhqg.now.sh/)                                                          | 모든 인도 도시를 깔끔한 JSON 형식으로 얻습니다.                                                                               | ❌       | ✅    | ✅         |
| [IP 2 Country](https://ip2country.info)                                                                                | IP를 국가에 매핑합니다.                                                                                                       | ❌       | ✅    | 알 수 없음 |
| [IP Address Details](https://ipinfo.io/)                                                                               | IP 주소를 사용하여 지리 위치를 찾습니다.                                                                                      | ❌       | ✅    | 알 수 없음 |
| [IP Location](http://ip-api.com/)                                                                                      | IP 주소가 있는 위치를 찾습니다.                                                                                               | ❌       | ❌    | 알 수 없음 |
| [IP Location](https://ipapi.co/)                                                                                       | IP 주소 위치 정보를 찾습니다.                                                                                                 | ❌       | ✅    | 알 수 없음 |
| [IP Sidekick](https://ipsidekick.com)                                                                                  | IP 주소에 대한 추가 정보를 반환하는 지리위치정보 API입니다.                                                                   | `apiKey` | ✅    | 알 수 없음 |
| [IP Vigilante](https://www.ipvigilante.com/)                                                                           | 무료 IP 지리위치정보 API                                                                                                      | ❌       | ✅    | 알 수 없음 |
| [IP2Location](https://www.ip2location.com/web-service/ip2location)                                                     | 55개 이상의 인자를 얻을 수 있는 IP 지리위치정보 웹 서비스                                                                     | `apiKey` | ✅    | 알 수 없음 |
| [IP2Proxy](https://www.ip2location.com/web-service/ip2proxy)                                                           | IP 주소를 사용하여 프록시 및 VPN을 검색합니다.                                                                                | `apiKey` | ✅    | 알 수 없음 |
| [IPGeolocationAPI.com](https://ipgeolocationapi.com/)                                                                  | 국가 세부 정보가 포함된 IP를 통해 방문자를 찾습니다.                                                                          | ❌       | ✅    | ✅         |
| [IPInfoDB](https://ipinfodb.com/api)                                                                                   | IP 주소로 국가, 지역, 도시 및 시간대 조회를 위한 무료 지역위치정보 도구와 API                                                 | `apiKey` | ✅    | 알 수 없음 |
| [ipstack](https://ipstack.com/)                                                                                        | IP 주소로 웹 사이트 방문자를 찾아 식별합니다.                                                                                 | `apiKey` | ✅    | 알 수 없음 |
...
| [Mapbox](https://www.mapbox.com/developers/)                                                                           | 아름다운 디지털 맵을 만들거나 사용자화합니다.                                                                                 | `apiKey` | ✅    | 알 수 없음 |
| [Mexico](https://github.com/IcaliaLabs/sepomex)                                                                        | 멕시코 RESTful zip code API                                                                                                   | ❌       | ✅    | 알 수 없음 |
| [One Map, Singapore](https://docs.onemap.sg/)                                                                          | 싱가포르 주소용 싱가포르 토지 당국 REST API 서비스                                                                            | `apiKey` | ✅    | 알 수 없음 |
| [OnWater](https://onwater.io/)                                                                                         | 위도/경도가 물 위에 있는지 또는 육지에 있는지 확인합니다.                                                                     | ❌       | ✅    | 알 수 없음 |
| [OpenCage](https://opencagedata.com)                                                                                   | 열린 데이터를 사용하여 지역위치정보를 확인합니다.                                                                             | `apiKey` | ✅    | ✅         |
| [OpenStreetMap](http://wiki.openstreetmap.org/wiki/API)                                                                | 탐색, 지리 위치 및 지리적 데이터                                                                                              | `OAuth`  | ❌    | 알 수 없음 |
| [PostcodeData.nl](http://api.postcodedata.nl/v1/postcode/?postcode=1211EP&streetnumber=60&ref=domeinnaam.nl&type=json) | 네덜란드어 주소의 우편 번호를 기준으로 지리 위치 데이터를 제공합니다.                                                         | ❌       | ❌    | 알 수 없음 |
| [Postcodes.io](https://postcodes.io)                                                                                   | 영국의 우편 번호 조회 및 지역위치정보                                                                                         | ❌       | ✅    | ✅         |
| [REST Countries](https://restcountries.eu)                                                                             | RESTful API를 통해 국가 정보를 얻습니다.                                                                                      | ❌       | ✅    | 알 수 없음 |
| [SmartIP.io](https://smartip.io)                                                                                       | IP 지역위치정보 및 위협 지능 API                                                                                              | `apiKey` | ✅    | ✅         |
| [Uebermaps](https://uebermaps.com/api/v2)                                                                              | 지도를 검색하고 친구들과 공유합니다.                                                                                          | `apiKey` | ✅    | 알 수 없음 |
| [US ZipCode](https://smartystreets.com/docs/cloud/us-zipcode-api)                                                      | US Zip Code에 대한 데이터를 확인하고 추가합니다.                                                                              | `apiKey` | ✅    | ✅         |
| [Utah AGRC](https://api.mapserv.utah.gov)                                                                              | 유타 주소 지역위치정보를 위한 유타 웹 API                                                                                     | `apiKey` | ✅    | 알 수 없음 |
| [ViaCep](https://viacep.com.br)                                                                                        | 브라질의 우편번호 API                                                                                                         | ❌       | ✅    | 알 수 없음 |
| [ZipCodeAPI](https://www.zipcodeapi.com)                                                                               | 미국 우편 번호 거리, 반경 및 위치 API                                                                                         | `apiKey` | ✅    | 알 수 없음 |
| [Zippopotam](http://www.zippopotam.us)                                                                                 | 국가, 도시, 주 등의 장소에 대한 정보를 얻습니다.                                                                              | ❌       | ❌    | 알 수 없음 |
...
| API                                                                                      | 설명                                                   | 인증     | HTTPS | CORS       |
| ---------------------------------------------------------------------------------------- | ------------------------------------------------------ | -------- | ----- | ---------- |
| [Adzuna](https://developer.adzuna.com/overview)                                          | 일자리 게시판 모음                                     | `apiKey` | ✅    | 알 수 없음 |
| [Authentic Jobs](https://authenticjobs.com/api/docs)                                     | 디자이너, 해커 및 창의적인 전문가를 위한 일자리 게시판 | `apiKey` | ✅    | 알 수 없음 |
| [Careerjet](https://www.careerjet.com/partners/api/)                                     | 일자리 검색 엔진                                       | `apiKey` | ❌    | 알 수 없음 |
| [Github Jobs](https://jobs.github.com/api)                                               | 소프트웨어 개발자를 위한 일자리                        | ❌       | ✅    | ✅         |
| [GraphQL Jobs](https://api.graphql.jobs)                                                 | GraphQL을 이용한 일자리                                | ❌       | ✅    | ✅         |
| [Indeed](https://www.indeed.com/publisher)                                               | 일자리 게시판 모음                                     | `apiKey` | ✅    | 알 수 없음 |
| [Jobs2Careers](http://api.jobs2careers.com/api/spec.pdf)                                 | 일자리 모음                                            | `apiKey` | ✅    | 알 수 없음 |
| [Jooble](https://us.jooble.org/api/about)                                                | 일자리 검색 엔진                                       | `apiKey` | ✅    | 알 수 없음 |
| [Juju](http://www.juju.com/publisher/spec/)                                              | 일자리 검색 엔진                                       | `apiKey` | ❌    | 알 수 없음 |
| [Open Skills](https://github.com/workforce-data-initiative/skills-api/wiki/API-Overview) | 일자리 제목, 기술 및 관련 작업 데이터                  | ❌       | ❌    | 알 수 없음 |
| [Reed](https://www.reed.co.uk/developers)                                                | 일자리 게시판 모음                                     | `apiKey` | ✅    | 알 수 없음 |
| [Search.gov Jobs](https://search.gov/developer/jobs.html)                                | 미국 정부의 일자리 목록                                | ❌       | ✅    | 알 수 없음 |
| [The Muse](https://www.themuse.com/developers/api/v2)                                    | 일자리 게시판과 회사 정보                              | `apiKey` | ✅    | 알 수 없음 |
| [Upwork](https://developers.upwork.com/)                                                 | 프리랜서 일자리 게시판과 관리 시스템                   | `OAuth`  | ✅    | 알 수 없음 |
| [USAJOBS](https://developer.usajobs.gov/)                                                | 미국 정부 일자리 게시판                                | `apiKey` | ✅    | 알 수 없음 |
| [ZipRecruiter](https://www.ziprecruiter.com/publishers)                                  | 일자리 검색 앱 및 웹 사이트                            | `apiKey` | ✅    | 알 수 없음 |
...
| API                                                                    | 설명                                                                                                           | 인증     | HTTPS | CORS       |
| ---------------------------------------------------------------------- | -------------------------------------------------------------------------------------------------------------- | -------- | ----- | ---------- |
| [Brazilian Vehicles and Prices](https://deividfortuna.github.io/fipe/) | Fundação Instituto de Pesquisas Econômicas의 차량 정보 - Fipe                                                  | ❌       | ✅    | 알 수 없음 |
...
| [NHTSA](https://vpic.nhtsa.dot.gov/api/)                               | NHTSA 제품 정보 카탈로그 및 차량 목록                                                                          | ❌       | ✅    | 알 수 없음 |
...
| [BookNomads](https://www.booknomads.com/dev)                              | 네덜란드와 플란데런에서 출판된 책 (약 250만), 책 표지와 관련된 데이터 | ❌       | ✅    | 알 수 없음 |
| [British National Bibliography](http://bnb.data.bl.uk/)                   | 책                                                                    | ❌       | ❌    | 알 수 없음 |
| [Goodreads](https://www.goodreads.com/api)                                | 책                                                                    | `apiKey` | ✅    | 알 수 없음 |
| [Google Books](https://developers.google.com/books/)                      | 책                                                                    | `OAuth`  | ✅    | 알 수 없음 |
| [LibGen](http://garbage.world/posts/libgen/)                              | 라이브러리 제네시스의 검색 엔진                                       | ❌       | ❌    | 알 수 없음 |
| [Open Library](https://openlibrary.org/developers/api)                    | 책, 책표지와 관련된 데이터                                            | ❌       | ✅    | 알 수 없음 |
| [Penguin Publishing](http://www.penguinrandomhouse.biz/webservices/rest/) | 책, 책표지와 관련된 데이터                                            | ❌       | ✅    | 알 수 없음 |
...
| API                                                                     | 설명                                             | 인증     | HTTPS | CORS       |
| ----------------------------------------------------------------------- | ------------------------------------------------ | -------- | ----- | ---------- |
| [Box](https://developer.box.com/)                                       | 파일 공유와 저장소                               | `OAuth`  | ✅    | 알 수 없음 |
| [Dropbox](https://www.dropbox.com/developers)                           | 파일 공유와 저장소                               | `OAuth`  | ✅    | 알 수 없음 |
| [Google Drive](https://developers.google.com/drive/)                    | 파일 공유와 저장소                               | `OAuth`  | ✅    | 알 수 없음 |
| [OneDrive](https://dev.onedrive.com/)                                   | 파일 공유와 저장소                               | `OAuth`  | ✅    | 알 수 없음 |
| [Pastebin](https://pastebin.com/api/)                                   | 평문 저장소                                      | `apiKey` | ✅    | 알 수 없음 |
...
| API                                                                        | 설명                                               | 인증            | HTTPS | CORS       |
| -------------------------------------------------------------------------- | -------------------------------------------------- | --------------- | ----- | ---------- |
| [Adorable Avatars](http://avatars.adorable.io)                             | 랜덤 만화 아바타를 생성합니다.                     | ❌              | ✅    | 알 수 없음 |
| [Bacon Ipsum](https://baconipsum.com/json-api/)                            | Meatier Lorem Ipsum 생성기                         | ❌              | ✅    | 알 수 없음 |
| [Dicebear Avatars](https://avatars.dicebear.com/)                          | 임의의 픽셀아트 아바타를 생성합니다.               | ❌              | ✅    | ❌         |
| [FakeJSON](https://fakejson.com)                                           | 테스트 및 가짜 데이터를 생성하는 서비스            | `apiKey`        | ✅    | ✅         |
| [FHIR](http://fhirtest.uhn.ca/home)                                        | 신속한 의료 상호 운용성의 리소스 테스트 데이터     | ❌              | ✅    | 알 수 없음 |
| [Hipster Ipsum](http://hipsterjesus.com/)                                  | Hipster Ipsum를 생성합니다.                        | ❌              | ❌    | 알 수 없음 |
| [Identicon](https://www.kwelo.com/media/identicon/)                        | 가상의 아바타 이미지를 생성합니다.                 | ❌              | ✅    | ✅         |
| [JSONPlaceholder](http://jsonplaceholder.typicode.com/)                    | 가짜 데이터를 테스트 및 프로토타이핑합니다.        | ❌              | ❌    | 알 수 없음 |
| [Lorem Text](https://market.mashape.com/montanaflynn/lorem-text-generator) | Lorem Ipsum를 생성합니다.                          | `X-Mashape-Key` | ✅    | 알 수 없음 |
| [LoremPicsum](http://lorempicsum.com)                                      | 플레이스홀더 사진을 생성합니다.                    | ❌              | ❌    | 알 수 없음 |
| [Loripsum](http://loripsum.net/)                                           | Lorem Ipsum를 생성합니다.                          | ❌              | ❌    | 알 수 없음 |
| [RandomUser](https://randomuser.me)                                        | 임의의 사용자 데이터를 생성합니다.                 | ❌              | ✅    | 알 수 없음 |
| [RoboHash](https://robohash.org/)                                          | 임의의 로봇/외계인 아바타를 생성합니다.            | ❌              | ✅    | 알 수 없음 |
| [This Person Does not Exist](https://thispersondoesnotexist.com)           | 존재하지 않는 사람들의 실제같은 얼굴을 생성합니다. | ❌              | ✅    | 알 수 없음 |
| [UI Names](https://github.com/thm/uinames)                                 | 임의의 가짜 이름을 생성합니다.                     | ❌              | ✅    | 알 수 없음 |
| [✅ ❌](https://yesno.wtf/api)                                             | 임의로 ✅ 또는 아니요를 생성합니다.                | ❌              | ✅    | 알 수 없음 |
...
| API                                                                                                                       | 설명                                                              | 인증            | HTTPS | CORS       |
| ------------------------------------------------------------------------------------------------------------------------- | ----------------------------------------------------------------- | --------------- | ----- | ---------- |
| [Aylien Text Analysis](http://docs.aylien.com/)                                                                           | 정보 검색 및 자연어 API의 집합                                    | `apiKey`        | ✅    | 알 수 없음 |
| [Cloudmersive Natural Language Processing](https://www.cloudmersive.com/nlp-api)                                          | 자연어 처리 및 텍스트 분석                                        | `apiKey`        | ✅    | ✅         |
| [Detect Language](https://detectlanguage.com/)                                                                            | 텍스트 언어를 감지합니다.                                         | `apiKey`        | ✅    | 알 수 없음 |
| [Google Cloud Natural](https://cloud.google.com/natural-language/docs/)                                                   | 감성 및 구문 분석을 포함한 자연어 이해 기술                       | `apiKey`        | ✅    | 알 수 없음 |
| [Language Identification](https://rapidapi.com/BigLobster/api/language-identification-prediction)                         | 모든 텍스트에 대한 자동 언어 감지합니다. (175개 이상의 언어 지원) | `X-Mashape-Key` | ✅    | 알 수 없음 |
| [Semantira](https://semantria.readme.io/docs)                                                                             | 감성 분석, 분류 및 명명된 엔티티를 추출하는 텍스트 분석           | `OAuth`         | ✅    | 알 수 없음 |
| [Watson Natural Language Understanding](https://www.ibm.com/watson/developercloud/natural-language-understanding/api/v1/) | 고급 텍스트 분석을 위한 자연 언어 처리                            | `OAuth`         | ✅    | 알 수 없음 |
...
| API                                              | 설명                                                               | 인증     | HTTPS | CORS       |
| ------------------------------------------------ | ------------------------------------------------------------------ | -------- | ----- | ---------- |
| [Postmon](http://postmon.com.br)                 | 쉽고, 빠르고, 무료로 브라질 ZIP 코드를 쿼리하고 주문할 수 있는 API | ❌       | ❌    | 알 수 없음 |
| [Sweden](https://developer.postnord.com/docs2)   | 운송 중인 소포에 대한 정보를 제공합니다.                           | `apiKey` | ❌    | 알 수 없음 |
| [UPS](https://www.ups.com/upsdeveloperkit)       | 발송 및 주소 정보                                                  | `apiKey` | ✅    | 알 수 없음 |
| [WhatPulse](https://whatpulse.org/pages/webapi/) | 키보드/마우스 사용량을 측정하는 어플리캐이션                       | ❌       | ✅    | 알 수 없음 |
...
| API                                                                           | 설명                    | 인증     | HTTPS | CORS       |
| ----------------------------------------------------------------------------- | ----------------------- | -------- | ----- | ---------- |
| [EPO](https://developers.epo.org/)                                            | 유럽 특허검색시스템 API | `OAuth`  | ✅    | 알 수 없음 |
| [TIPO](https://tiponet.tipo.gov.tw/Gazette/OpenData/OD/OD05.aspx?QryDS=API00) | 대만 특허검색시스템 API | `apiKey` | ✅    | 알 수 없음 |
| [USPTO](https://www.uspto.gov/learning-and-resources/open-data-and-mobility)  | 미국 특허 API 서비스    | ❌       | ✅    | 알 수 없음 |
...
| API                                                                                                                             | 설명                               | 인증     | HTTPS | CORS       |
| ------------------------------------------------------------------------------------------------------------------------------- | ---------------------------------- | -------- | ----- | ---------- |
| [Eventbrite](https://www.eventbrite.com/developer/v3/)                                                                          | 행사를 찾아보세요                  | `OAuth`  | ✅    | 알 수 없음 |
| [Picatic](http://developer.picatic.com/?utm_medium=web&utm_source=github&utm_campaign=public-apis%20repo&utm_content=toddmotto) | 어디서든 티켓을 팔아보세요.        | `apiKey` | ✅    | 알 수 없음 |
| [Ticketmaster](http://developer.ticketmaster.com/products-and-docs/apis/getting-started/)                                       | 행사, 명소 또는 장소를 검색합니다. | `apiKey` | ✅    | 알 수 없음 |
...
| API                                                                                                    | 설명                                               | 인증     | HTTPS | CORS       |
| ------------------------------------------------------------------------------------------------------ | -------------------------------------------------- | -------- | ----- | ---------- |
| [AirVisual](https://airvisual.com/api)                                                                 | 공기 질과 날씨 데이터                              | `apiKey` | ✅    | 알 수 없음 |
| [GrünstromIndex](https://www.corrently.de/hintergrund/gruenstromindex/index.html)                      | 독일의 녹색 전력 지수(Grünstromindex/GSI).         | ❌       | ❌    | ✅         |
| [OpenAQ](https://docs.openaq.org/)                                                                     | 공개 공기 질 데이터                                | `apiKey` | ✅    | 알 수 없음 |
| [PM25.in](http://www.pm25.in/api_doc)                                                                  | 중국의 공기 질                                     | `apiKey` | ❌    | 알 수 없음 |
| [PVWatts](https://developer.nrel.gov/docs/solar/pvwatts/v6/)                                           | 에너지 생산 광전(PV) 에너지 시스템                 | `apiKey` | ✅    | 알 수 없음 |
| [UK Carbon Intensity](https://carbon-intensity.github.io/api-definitions/#carbon-intensity-api-v1-0-0) | National Grid에서 개발한 영국 공식 탄소 집약도 API | ❌       | ✅    | 알 수 없음 |
...
| API                                                                                                          | 설명                        | 인증     | HTTPS | CORS       |
| ------------------------------------------------------------------------------------------------------------ | --------------------------- | -------- | ----- | ---------- |
| [1Forge](https://1forge.com/forex-data-api/api-documentation)                                                | 외환시장 데이터             | `apiKey` | ✅    | 알 수 없음 |
| [Currencylayer](https://currencylayer.com/documentation)                                                     | 교환비율과 통화변환         | `apiKey` | ✅    | 알 수 없음 |
| [Czech National Bank](https://www.cnb.cz/cs/financni_trhy/devizovy_trh/kurzy_devizoveho_trhu/denni_kurz.xml) | 교환비율 모음               | ❌       | ✅    | 알 수 없음 |
| [ExchangeRate-API](https://www.exchangerate-api.com)                                                         | 무료 통화변환               | ❌       | ✅    | ✅         |
| [Exchangeratesapi.io](https://exchangeratesapi.io)                                                           | 통화변환과 교환비율         | ❌       | ✅    | ✅         |
| [Fixer.io](http://fixer.io)                                                                                  | 교환비율과 통화변환         | `apiKey` | ✅    | 알 수 없음 |
| [Frankfurter](https://www.frankfurter.app/docs)                                                              | 교환비율, 통화변환과 시계열 | ❌       | ✅    | ✅         |
| [ratesapi](https://ratesapi.io)                                                                              | 무료 교환비율과 역사적비율  | ❌       | ✅    | 알 수 없음 |
...
| API                                                                        | 설명                                                   | 인증     | HTTPS | CORS       |
| -------------------------------------------------------------------------- | ------------------------------------------------------ | -------- | ----- | ---------- |
| [Bitly](http://dev.bitly.com/get_started.html)                             | URL 쇼트너와 링크 관리                                 | `OAuth`  | ✅    | 알 수 없음 |
| [CleanURI](https://cleanuri.com/docs)                                      | URL 쇼트너 서비스                                      | ❌       | ✅    | ✅         |
| [ClickMeter](https://support.clickmeter.com/hc/en-us/categories/201474986) | 당신의 마케팅 링크를 모니터하고 비교하고 최적화합니다. | `apiKey` | ✅    | 알 수 없음 |
| [Rebrandly](https://developers.rebrandly.com/v1/docs)                      | URL 쇼트너 브랜드 링크 커스텀                          | `apiKey` | ✅    | 알 수 없음 |
...
| API                                                                                | 설명                                      | 인증     | HTTPS      | CORS       |
| ---------------------------------------------------------------------------------- | ----------------------------------------- | -------- | ---------- | ---------- |
| [카카오톡 사용자 관리](https://developers.kakao.com/features/platform#사용자-관리) | 카카오 계정 사용자 관리                   | `apiKey` | 알 수 없음 | 알 수 없음 |
| [카카오톡 친구](https://developers.kakao.com/features/platform#친구-API)           | 카카오톡 친구 목록을 활용해 소셜 기능까지 | `apiKey` | 알 수 없음 | 알 수 없음 |
| [카카오링크](https://developers.kakao.com/features/kakao#카카오-링크)              | 카카오 링크                               | `apiKey` | 알 수 없음 | 알 수 없음 |
| [카카오톡](https://developers.kakao.com/features/kakao#카카오톡-API)               | 카카오톡                                  | `apiKey` | 알 수 없음 | 알 수 없음 |
| [카카오내비](https://developers.kakao.com/features/kakao#카카오내비-API)           | 카카오내비                                | `apiKey` | 알 수 없음 | 알 수 없음 |
| [카카오페이](https://developers.kakao.com/features/kakao#카카오페이-API)           | 카카오페이                                | `apiKey` | 알 수 없음 | 알 수 없음 |
| [카카오스토리](https://developers.kakao.com/features/kakao#카카오스토리-API)       | 카카오스토리                              | `apiKey` | 알 수 없음 | 알 수 없음 |
| [카카오톡 푸시 알림](https://developers.kakao.com/features/platform#푸시-알림)     | 카카오톡 푸시 알림                        | `apiKey` | 알 수 없음 | 알 수 없음 |
| [카카오 앱로그 분석](https://developers.kakao.com/features/platform#앱로그-분석)   | 카카오 앱로그 분석                        | `apiKey` | 알 수 없음 | 알 수 없음 |
| [카카오 검색](https://developers.kakao.com/features/platform#검색)                 | 카카오 검색                               | `apiKey` | 알 수 없음 | 알 수 없음 |
| [카카오 음성](https://developers.kakao.com/features/platform#음성)                 | 카카오 음성                               | `apiKey` | 알 수 없음 | 알 수 없음 |
| [카카오 지도/로컬](https://developers.kakao.com/features/platform#지도-로컬)       | 카카오 지도/로컬                          | `apiKey` | 알 수 없음 | 알 수 없음 |
| [카카오 비전](https://developers.kakao.com/features/platform#비전)                 | 카카오 비전                               | `apiKey` | 알 수 없음 | 알 수 없음 |
| [카카오 번역](https://developers.kakao.com/features/platform#번역)                 | 카카오 번역                               | `apiKey` | 알 수 없음 | 알 수 없음 |
| [카카오톡 채널](https://developers.kakao.com/features/kakao#카카오톡-채널-API)     | 카카오톡 채널                             | `apiKey` | 알 수 없음 | 알 수 없음 |
| [카카오모먼트](https://developers.kakao.com/features/kakao#카카오모먼트-API)       | 카카오모먼트                              | `apiKey` | 알 수 없음 | 알 수 없음 |
