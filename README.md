...
| API                                                                                                              | 설명                                                                                    | 인증     | HTTPS | CORS       |
| ---------------------------------------------------------------------------------------------------------------- | --------------------------------------------------------------------------------------- | -------- | ----- | ---------- |
| [AI Mastering](https://aimastering.com/api_docs/)                                                                | 자동화된 음악 마스터링                                                                  | `apiKey` | 예    | 예         |
| [Bandsintown](https://app.swaggerhub.com/apis/Bandsintown/PublicAPI/3.0.0)                                       | 음악 행사                                                                               | 아니요   | 예    | 알 수 없음 |
| [Deezer](https://developers.deezer.com/api)                                                                      | 음악                                                                                    | `OAuth`  | 예    | 알 수 없음 |
| [Discogs](https://www.discogs.com/developers/)                                                                   | 음악                                                                                    | `OAuth`  | 예    | 알 수 없음 |
| [Genius](https://docs.genius.com/)                                                                               | 풍부한 가사와 음악 지식                                                                 | `OAuth`  | 예    | 알 수 없음 |
| [Genrenator](https://binaryjazz.us/genrenator-api/)                                                              | 음악 장르 생성기                                                                        | 아니요   | 예    | 알 수 없음 |
| [iTunes Search](https://affiliate.itunes.apple.com/resources/documentation/itunes-store-web-service-search-api/) | 소프트웨어 제품                                                                         | 아니요   | 예    | 알 수 없음 |
| [Jamendo](https://developer.jamendo.com/v3.0/docs)                                                               | 음악                                                                                    | `OAuth`  | 예    | 알 수 없음 |
| [KKBOX](https://developer.kkbox.com)                                                                             | KKBOX 플랫폼에서 음악 라이브러리, 재생 목록, 차트 및 공연을 가져옵니다.                 | `OAuth`  | 예    | 알 수 없음 |
| [LastFm](https://www.last.fm/api)                                                                                | 음악                                                                                    | `apiKey` | 예    | 알 수 없음 |
| [Lyrics.ovh](http://docs.lyricsovh.apiary.io/)                                                                   | 노래 가사를 검색하는 간단한 API                                                         | 아니요   | 예    | 알 수 없음 |
| [Mixcloud](https://www.mixcloud.com/developers/)                                                                 | 음악                                                                                    | `OAuth`  | 예    | 예         |
| [MusicBrainz](https://musicbrainz.org/doc/Development/XML_Web_Service/Version_2)                                 | 음악                                                                                    | 아니요   | 예    | 알 수 없음 |
| [Musikki](https://music-api.musikki.com/reference)                                                               | 음악                                                                                    | `apiKey` | 예    | 알 수 없음 |
| [Musixmatch](https://developer.musixmatch.com/)                                                                  | 음악                                                                                    | `apiKey` | 예    | 알 수 없음 |
| [Openwhyd](https://openwhyd.github.io/openwhyd/API)                                                              | 스트리밍 트랙의 큐레이션된 재생 목록(YouTube, SoundCloud 등)을 다운로드합니다.          | `아니요` | 예    | 아니요     |
| [Songkick](https://www.songkick.com/developer/)                                                                  | 음악 행사                                                                               | `OAuth`  | 예    | 알 수 없음 |
| [Songsterr](https://www.songsterr.com/a/wa/api/)                                                                 | 기타, 베이스 및 드럼 탭과 코드를 제공합니다.                                            | 아니요   | 예    | 알 수 없음 |
| [SoundCloud](https://developers.soundcloud.com/)                                                                 | 사용자가 소리를 업로드하고 공유합니다.                                                  | `OAuth`  | 예    | 알 수 없음 |
| [Spotify](https://beta.developer.spotify.com/documentation/web-api/)                                             | 스포티파이의 음악 카탈로그 지정, 사용자 라이브러리 관리, 권장 사항 등을 볼 수 있습니다. | `OAuth`  | 예    | 알 수 없음 |
| [TasteDive](https://tastedive.com/read/api)                                                                      | 유사한 아티스트 API(영화 및 TV 프로그램에도 적용됩니다)                                 | `apiKey` | 예    | 알 수 없음 |
| [TheAudioDB](https://www.theaudiodb.com/api_guide.php)                                                           | 음악                                                                                    | `apiKey` | 예    | 알 수 없음 |
| [Vagalume](https://api.vagalume.com.br/docs/)                                                                    | 풍부한 가사와 음악 지식                                                                 | `apiKey` | 예    | 알 수 없음 |
